...
{
  QSqlTableModel_release_codeblocks();
}
void SlotsQSqlTableModel::beforeDelete ( int row )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "beforeDelete(int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM prow = hb_itemPutNI( NULL, row );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, prow );
...
void SlotsQSqlTableModel::beforeInsert ( QSqlRecord & record )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "beforeInsert(QSqlRecord)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM precord = hb_itemPutPtr( NULL, (QSqlRecord *) &record );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, precord );
        hb_itemRelease( psender );
...
void SlotsQSqlTableModel::beforeUpdate ( int row, QSqlRecord & record )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "beforeUpdate(int,QSqlRecord)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM prow = hb_itemPutNI( NULL, row );
        PHB_ITEM precord = hb_itemPutPtr( NULL, (QSqlRecord *) &record );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 3, psender, prow, precord );
        hb_itemRelease( psender );
        hb_itemRelease( prow );
        hb_itemRelease( precord );
      }
...
void SlotsQSqlTableModel::primeInsert ( int row, QSqlRecord & record )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "primeInsert(int,QSqlRecord)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM prow = hb_itemPutNI( NULL, row );
        PHB_ITEM precord = hb_itemPutPtr( NULL, (QSqlRecord *) &record );
