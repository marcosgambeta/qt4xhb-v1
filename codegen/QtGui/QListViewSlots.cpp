...
void SlotsQListView::indexesMoved ( const QModelIndexList & indexes )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "indexesMoved(QModelIndexList)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pindexes = hb_itemPutPtr( NULL, (QModelIndexList *) &indexes );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pindexes );
