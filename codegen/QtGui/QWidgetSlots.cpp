...
void SlotsQWidget::customContextMenuRequested ( const QPoint & pos )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "customContextMenuRequested(QPoint)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM ppos = hb_itemPutPtr( NULL, (QPoint *) &pos );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, ppos );
