...
{
  QDesktopWidget_release_codeblocks();
}
void SlotsQDesktopWidget::resized ( int screen )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "resized(int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pscreen = hb_itemPutNI( NULL, screen );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pscreen );
...
void SlotsQDesktopWidget::screenCountChanged ( int newCount )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "screenCountChanged(int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pnewCount = hb_itemPutNI( NULL, newCount );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pnewCount );
        hb_itemRelease( psender );
...
void SlotsQDesktopWidget::workAreaResized ( int screen )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "workAreaResized(int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pscreen = hb_itemPutNI( NULL, screen );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pscreen );
