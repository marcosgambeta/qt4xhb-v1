...
void SlotsQTextEdit::copyAvailable ( bool yes )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "copyAvailable(bool)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pyes = hb_itemPutL( NULL, yes );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pyes );
...
void SlotsQTextEdit::currentCharFormatChanged ( const QTextCharFormat & f )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "currentCharFormatChanged(QTextCharFormat)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pf = hb_itemPutPtr( NULL, (QTextCharFormat *) &f );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pf );
        hb_itemRelease( psender );
        hb_itemRelease( pf );
      }
    }
...
void SlotsQTextEdit::cursorPositionChanged ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "cursorPositionChanged()" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
...
void SlotsQTextEdit::textChanged ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "textChanged()" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 1, psender );
        hb_itemRelease( psender );
