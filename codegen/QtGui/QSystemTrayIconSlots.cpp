...
{
  QSystemTrayIcon_release_codeblocks();
}
void SlotsQSystemTrayIcon::activated ( QSystemTrayIcon::ActivationReason reason )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "activated(QSystemTrayIcon::ActivationReason)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM preason = hb_itemPutNI( NULL, (int) reason );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, preason );
...
void SlotsQSystemTrayIcon::messageClicked ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "messageClicked()" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
