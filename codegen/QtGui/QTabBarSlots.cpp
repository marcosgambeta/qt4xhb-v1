...
void SlotsQTabBar::currentChanged ( int index )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "currentChanged(int)" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQTabBar::tabCloseRequested ( int index )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "tabCloseRequested(int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pindex = hb_itemPutNI( NULL, index );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pindex );
...
void SlotsQTabBar::tabMoved ( int from, int to )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "tabMoved(int,int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pfrom = hb_itemPutNI( NULL, from );
        PHB_ITEM pto = hb_itemPutNI( NULL, to );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 3, psender, pfrom, pto );
        hb_itemRelease( psender );
