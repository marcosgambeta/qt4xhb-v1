...
{
  QMdiSubWindow_release_codeblocks();
}
void SlotsQMdiSubWindow::aboutToActivate ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "aboutToActivate()" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQMdiSubWindow::windowStateChanged ( Qt::WindowStates oldState, Qt::WindowStates newState )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "windowStateChanged(Qt::WindowStates,Qt::WindowStates)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM poldState = hb_itemPutNI( NULL, (int) oldState );
        PHB_ITEM pnewState = hb_itemPutNI( NULL, (int) newState );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 3, psender, poldState, pnewState );
        hb_itemRelease( psender );
