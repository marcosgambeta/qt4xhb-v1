...
$prototype=void drawConvexPolygon ( const QPoint * points, int pointCount )
...
$prototype=void drawLines ( const QLine * lines, int lineCount )

$prototype=void drawLines ( const QPointF * pointPairs, int lineCount )
...
$prototype=void drawPoints ( const QPoint * points, int pointCount )
...
$prototype=void drawPolygon ( const QPoint * points, int pointCount, Qt::FillRule fillRule = Qt::OddEvenFill )
...
$prototype=void drawPolyline ( const QPoint * points, int pointCount )
...
$prototypeV2=void initFrom( const QWidget * widget )
