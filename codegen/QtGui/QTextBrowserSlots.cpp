...
{
  QTextBrowser_release_codeblocks();
}
void SlotsQTextBrowser::anchorClicked ( const QUrl & link )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "anchorClicked(QUrl)" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQTextBrowser::backwardAvailable ( bool available )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "backwardAvailable(bool)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
...
void SlotsQTextBrowser::forwardAvailable ( bool available )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "forwardAvailable(bool)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pavailable = hb_itemPutL( NULL, available );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pavailable );
...
void SlotsQTextBrowser::highlighted ( const QUrl & link )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "highlighted(QUrl)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM plink = hb_itemPutPtr( NULL, (QUrl *) &link );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, plink );
...
void SlotsQTextBrowser::historyChanged ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "historyChanged()" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
...
void SlotsQTextBrowser::sourceChanged ( const QUrl & src )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "sourceChanged(QUrl)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM psrc = hb_itemPutPtr( NULL, (QUrl *) &src );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, psrc );
        hb_itemRelease( psender );
        hb_itemRelease( psrc );
      }
    }
