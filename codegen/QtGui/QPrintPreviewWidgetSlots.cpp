...
{
  QPrintPreviewWidget_release_codeblocks();
}
void SlotsQPrintPreviewWidget::paintRequested ( QPrinter * printer )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "paintRequested(QPrinter*)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pprinter = hb_itemPutPtr( NULL, (QPrinter *) printer );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pprinter );
...
void SlotsQPrintPreviewWidget::previewChanged ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "previewChanged()" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
