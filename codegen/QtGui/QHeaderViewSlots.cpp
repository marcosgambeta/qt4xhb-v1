...
{
  QHeaderView_release_codeblocks();
}
void SlotsQHeaderView::geometriesChanged ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "geometriesChanged()" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQHeaderView::sectionAutoResize ( int logicalIndex, QHeaderView::ResizeMode mode )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "sectionAutoResize(int,QHeaderView::ResizeMode)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM plogicalIndex = hb_itemPutNI( NULL, logicalIndex );
        PHB_ITEM pmode = hb_itemPutNI( NULL, (int) mode );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 3, psender, plogicalIndex, pmode );
        hb_itemRelease( psender );
...
void SlotsQHeaderView::sectionClicked ( int logicalIndex )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "sectionClicked(int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM plogicalIndex = hb_itemPutNI( NULL, logicalIndex );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, plogicalIndex );
        hb_itemRelease( psender );
        hb_itemRelease( plogicalIndex );
      }
    }
...
void SlotsQHeaderView::sectionCountChanged ( int oldCount, int newCount )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "sectionCountChanged(int,int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM poldCount = hb_itemPutNI( NULL, oldCount );
        PHB_ITEM pnewCount = hb_itemPutNI( NULL, newCount );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 3, psender, poldCount, pnewCount );
        hb_itemRelease( psender );
...
void SlotsQHeaderView::sectionDoubleClicked ( int logicalIndex )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "sectionDoubleClicked(int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM plogicalIndex = hb_itemPutNI( NULL, logicalIndex );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, plogicalIndex );
...
void SlotsQHeaderView::sectionEntered ( int logicalIndex )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "sectionEntered(int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM plogicalIndex = hb_itemPutNI( NULL, logicalIndex );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, plogicalIndex );
...
void SlotsQHeaderView::sectionHandleDoubleClicked ( int logicalIndex )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "sectionHandleDoubleClicked(int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM plogicalIndex = hb_itemPutNI( NULL, logicalIndex );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, plogicalIndex );
...
void SlotsQHeaderView::sectionMoved ( int logicalIndex, int oldVisualIndex, int newVisualIndex )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "sectionMoved(int,int,int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM plogicalIndex = hb_itemPutNI( NULL, logicalIndex );
        PHB_ITEM poldVisualIndex = hb_itemPutNI( NULL, oldVisualIndex );
        PHB_ITEM pnewVisualIndex = hb_itemPutNI( NULL, newVisualIndex );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 4, psender, plogicalIndex, poldVisualIndex, pnewVisualIndex );
        hb_itemRelease( psender );
        hb_itemRelease( plogicalIndex );
...
void SlotsQHeaderView::sectionPressed ( int logicalIndex )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "sectionPressed(int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM plogicalIndex = hb_itemPutNI( NULL, logicalIndex );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, plogicalIndex );
...
void SlotsQHeaderView::sectionResized ( int logicalIndex, int oldSize, int newSize )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "sectionResized(int,int,int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM plogicalIndex = hb_itemPutNI( NULL, logicalIndex );
        PHB_ITEM poldSize = hb_itemPutNI( NULL, oldSize );
        PHB_ITEM pnewSize = hb_itemPutNI( NULL, newSize );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 4, psender, plogicalIndex, poldSize, pnewSize );
        hb_itemRelease( psender );
        hb_itemRelease( plogicalIndex );
...
void SlotsQHeaderView::sortIndicatorChanged ( int logicalIndex, Qt::SortOrder order )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "sortIndicatorChanged(int,Qt::SortOrder)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM plogicalIndex = hb_itemPutNI( NULL, logicalIndex );
        PHB_ITEM porder = hb_itemPutNI( NULL, (int) order );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 3, psender, plogicalIndex, porder );
        hb_itemRelease( psender );
        hb_itemRelease( plogicalIndex );
