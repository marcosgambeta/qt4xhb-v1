...
{
  QColorDialog_release_codeblocks();
}
void SlotsQColorDialog::colorSelected ( const QColor & color )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "colorSelected(QColor)" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQColorDialog::currentColorChanged ( const QColor & color )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "currentColorChanged(QColor)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pcolor = hb_itemPutPtr( NULL, (QColor *) &color );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pcolor );
