...
{
  QGraphicsOpacityEffect_release_codeblocks();
}
void SlotsQGraphicsOpacityEffect::opacityChanged ( qreal opacity )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "opacityChanged(qreal)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM popacity = hb_itemPutND( NULL, opacity );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, popacity );
...
void SlotsQGraphicsOpacityEffect::opacityMaskChanged ( const QBrush & mask )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "opacityMaskChanged(QBrush)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pmask = hb_itemPutPtr( NULL, (QBrush *) &mask );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pmask );
        hb_itemRelease( psender );
