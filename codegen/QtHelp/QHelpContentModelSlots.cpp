...
{
  QHelpContentModel_release_codeblocks();
}
void SlotsQHelpContentModel::contentsCreated ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "contentsCreated()" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQHelpContentModel::contentsCreationStarted ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "contentsCreationStarted()" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 1, psender );
        hb_itemRelease( psender );
