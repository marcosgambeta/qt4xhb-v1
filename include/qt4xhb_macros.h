...
#define INHERITS(a,b)                                       Qt4xHb::_qt4xhb_isObjectDerivedFrom(a,b)

#define ISQSTRINGREF(n)                                     Qt4xHb::_qt4xhb_isObjectDerivedFrom(n,"QStringRef")
#define PQSTRINGREF(n)                                      (QStringRef *) Qt4xHb::_qt4xhb_itemGetPtr(n)
#define PQLATIN1CHAR(n)                                     (QLatin1Char *) Qt4xHb::_qt4xhb_itemGetPtr(n)
#define ISQLATIN1STRING(n)                                  Qt4xHb::_qt4xhb_isObjectDerivedFrom(n,"QLatin1String")
#define PQLATIN1STRING(n)                                   (QLatin1String *) Qt4xHb::_qt4xhb_itemGetPtr(n)
#define PQXMLSTREAMNAMESPACEDECLARATIONS(n)                 (QXmlStreamNamespaceDeclarations *) Qt4xHb::_qt4xhb_itemGetPtr(n)
#define ISQSTYLEOPTIONVIEWITEM(n)                           Qt4xHb::_qt4xhb_isObjectDerivedFrom(n,"QStyleOptionViewItem")
#define PQSTYLEOPTIONVIEWITEM(n)                            (QStyleOptionViewItem *) Qt4xHb::_qt4xhb_itemGetPtr(n)
#define ISQMATRIX(n)                                        Qt4xHb::_qt4xhb_isObjectDerivedFrom(n,"QMatrix")
#define PQMATRIX(n)                                         (QMatrix *) Qt4xHb::_qt4xhb_itemGetPtr(n)
#define ISQSTYLEOPTION(n)                                   Qt4xHb::_qt4xhb_isObjectDerivedFrom(n,"QStyleOption")
#define PQSTYLEOPTION(n)                                    (QStyleOption *) Qt4xHb::_qt4xhb_itemGetPtr(n)
#define ISQSTYLEOPTIONCOMPLEX(n)                            Qt4xHb::_qt4xhb_isObjectDerivedFrom(n,"QStyleOptionComplex")
#define PQSTYLEOPTIONCOMPLEX(n)                             (QStyleOptionComplex *) Qt4xHb::_qt4xhb_itemGetPtr(n)
#define ISQSTYLEOPTIONGRAPHICSITEM(n)                       Qt4xHb::_qt4xhb_isObjectDerivedFrom(n,"QStyleOptionGraphicsItem")
#define PQSTYLEOPTIONGRAPHICSITEM(n)                        (QStyleOptionGraphicsItem *) Qt4xHb::_qt4xhb_itemGetPtr(n)
#define ISQQUATERNION(n)                                    Qt4xHb::_qt4xhb_isObjectDerivedFrom(n,"QQuaternion")
#define PQQUATERNION(n)                                     (QQuaternion *) Qt4xHb::_qt4xhb_itemGetPtr(n)
#define ISQPLATFORMGLCONTEXT(n)                             Qt4xHb::_qt4xhb_isObjectDerivedFrom(n,"QPlatformGLContext")
#define PQPLATFORMGLCONTEXT(n)                              (QPlatformGLContext *) Qt4xHb::_qt4xhb_itemGetPtr(n)
#define PQTEXTENGINE(n)                                     (QTextEngine *) Qt4xHb::_qt4xhb_itemGetPtr(n)
#define PQSTRINGLIST(n)                                     Qt4xHb::_qt4xhb_convert_array_parameter_to_qstringlist(n)
#define OPQSTRINGLIST(n,v)                                  ISNIL(n)? v : Qt4xHb::_qt4xhb_convert_array_parameter_to_qstringlist(n)
#define PQVARIANTLIST(n)                                    Qt4xHb::_qt4xhb_convert_array_parameter_to_qvariantlist(n)
#define OPQVARIANTLIST(n,v)                                 ISNIL(n)? v : Qt4xHb::_qt4xhb_convert_array_parameter_to_qvariantlist(n)
...
#define RQSTRINGLIST(x)                                     Qt4xHb::_qt4xhb_convert_qstringlist_to_array( x )
