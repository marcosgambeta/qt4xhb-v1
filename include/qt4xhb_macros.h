...
#define OPSHORT(n,v)                                        static_cast< short >( ISNIL( n ) ? v : hb_parni( n ) )
...
#define OPQLONGLONG(n,v)                                    static_cast< qlonglong >( ISNIL( n ) ? v : hb_parnll( n)  )
#define OPQULONGLONG(n,v)                                   static_cast< qulonglong >( ISNIL( n ) ? v : hb_parnll( n ) )
