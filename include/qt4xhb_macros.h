...
#define PQSTRINGREF(n)                                      (QStringRef *) _qt4xhb_itemGetPtr(n)
#define PQLATIN1CHAR(n)                                     (QLatin1Char *) _qt4xhb_itemGetPtr(n)
#define ISQLATIN1STRING(n)                                  _qt4xhb_isObjectDerivedFrom(n,"QLatin1String")
#define PQLATIN1STRING(n)                                   (QLatin1String *) _qt4xhb_itemGetPtr(n)
#define PQXMLSTREAMNAMESPACEDECLARATIONS(n)                 (QXmlStreamNamespaceDeclarations *) _qt4xhb_itemGetPtr(n)
#define ISQSTYLEOPTIONVIEWITEM(n)                           _qt4xhb_isObjectDerivedFrom(n,"QStyleOptionViewItem")
#define PQSTYLEOPTIONVIEWITEM(n)                            (QStyleOptionViewItem *) _qt4xhb_itemGetPtr(n)
#define ISQMATRIX(n)                                        _qt4xhb_isObjectDerivedFrom(n,"QMatrix")
#define PQMATRIX(n)                                         (QMatrix *) _qt4xhb_itemGetPtr(n)
#define ISQSTYLEOPTION(n)                                   _qt4xhb_isObjectDerivedFrom(n,"QStyleOption")
#define PQSTYLEOPTION(n)                                    (QStyleOption *) _qt4xhb_itemGetPtr(n)
#define ISQSTYLEOPTIONCOMPLEX(n)                            _qt4xhb_isObjectDerivedFrom(n,"QStyleOptionComplex")
#define PQSTYLEOPTIONCOMPLEX(n)                             (QStyleOptionComplex *) _qt4xhb_itemGetPtr(n)
#define ISQSTYLEOPTIONGRAPHICSITEM(n)                       _qt4xhb_isObjectDerivedFrom(n,"QStyleOptionGraphicsItem")
#define PQSTYLEOPTIONGRAPHICSITEM(n)                        (QStyleOptionGraphicsItem *) _qt4xhb_itemGetPtr(n)
#define ISQQUATERNION(n)                                    _qt4xhb_isObjectDerivedFrom(n,"QQuaternion")
#define PQQUATERNION(n)                                     (QQuaternion *) _qt4xhb_itemGetPtr(n)
#define ISQPLATFORMGLCONTEXT(n)                             _qt4xhb_isObjectDerivedFrom(n,"QPlatformGLContext")
#define PQPLATFORMGLCONTEXT(n)                              (QPlatformGLContext *) _qt4xhb_itemGetPtr(n)
#define PQTEXTENGINE(n)                                     (QTextEngine *) _qt4xhb_itemGetPtr(n)
#define PQSTRINGLIST(n)                                     _qt4xhb_convert_array_parameter_to_qstringlist(n)
#define OPQSTRINGLIST(n,v)                                  ISNIL(n)? v : _qt4xhb_convert_array_parameter_to_qstringlist(n)
#define PQVARIANTLIST(n)                                    _qt4xhb_convert_array_parameter_to_qvariantlist(n)
#define OPQVARIANTLIST(n,v)                                 ISNIL(n)? v : _qt4xhb_convert_array_parameter_to_qvariantlist(n)
