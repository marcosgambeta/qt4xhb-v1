...
#define OPQABSTRACTMESSAGEHANDLER( n, v )                      ISNIL( n ) ? v : static_cast< QAbstractMessageHandler * >( Qt4xHb::itemGetPtr( n ) )
#define OPQABSTRACTURIRESOLVER( n, v )                         ISNIL( n ) ? v : static_cast< QAbstractUriResolver * >( Qt4xHb::itemGetPtr( n ) )
#define OPQABSTRACTXMLNODEMODEL( n, v )                        ISNIL( n ) ? v : static_cast< QAbstractXmlNodeModel * >( Qt4xHb::itemGetPtr( n ) )
#define OPQABSTRACTXMLRECEIVER( n, v )                         ISNIL( n ) ? v : static_cast< QAbstractXmlReceiver * >( Qt4xHb::itemGetPtr( n ) )
#define OPQSIMPLEXMLNODEMODEL( n, v )                          ISNIL( n ) ? v : static_cast< QSimpleXmlNodeModel * >( Qt4xHb::itemGetPtr( n ) )
#define OPQSOURCELOCATION( n, v )                              ISNIL( n ) ? v : static_cast< QSourceLocation * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLFORMATTER( n, v )                                ISNIL( n ) ? v : static_cast< QXmlFormatter * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLITEM( n, v )                                     ISNIL( n ) ? v : static_cast< QXmlItem * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLNAME( n, v )                                     ISNIL( n ) ? v : static_cast< QXmlName * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLNAMEPOOL( n, v )                                 ISNIL( n ) ? v : static_cast< QXmlNamePool * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLNODEMODELINDEX( n, v )                           ISNIL( n ) ? v : static_cast< QXmlNodeModelIndex * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLQUERY( n, v )                                    ISNIL( n ) ? v : static_cast< QXmlQuery * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLRESULTITEMS( n, v )                              ISNIL( n ) ? v : static_cast< QXmlResultItems * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLSCHEMA( n, v )                                   ISNIL( n ) ? v : static_cast< QXmlSchema * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLSCHEMAVALIDATOR( n, v )                          ISNIL( n ) ? v : static_cast< QXmlSchemaValidator * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLSERIALIZER( n, v )                               ISNIL( n ) ? v : static_cast< QXmlSerializer * >( Qt4xHb::itemGetPtr( n ) )
