...
#ifndef QT4XHB_MACROS_QTXML_HPP
#define QT4XHB_MACROS_QTXML_HPP
...
#define RQDOMATTR(exp)                                      Qt4xHb::createReturnClass(new QDomAttr(exp), "QDOMATTR", true)
#define RQDOMCDATASECTION(exp)                              Qt4xHb::createReturnClass(new QDomCDATASection(exp), "QDOMCDATASECTION", true)
#define RQDOMCHARACTERDATA(exp)                             Qt4xHb::createReturnClass(new QDomCharacterData(exp), "QDOMCHARACTERDATA", true)
#define RQDOMCOMMENT(exp)                                   Qt4xHb::createReturnClass(new QDomComment(exp), "QDOMCOMMENT", true)
#define RQDOMDOCUMENT(exp)                                  Qt4xHb::createReturnClass(new QDomDocument(exp), "QDOMDOCUMENT", true)
#define RQDOMDOCUMENTFRAGMENT(exp)                          Qt4xHb::createReturnClass(new QDomDocumentFragment(exp), "QDOMDOCUMENTFRAGMENT", true)
#define RQDOMDOCUMENTTYPE(exp)                              Qt4xHb::createReturnClass(new QDomDocumentType(exp), "QDOMDOCUMENTTYPE", true)
#define RQDOMELEMENT(exp)                                   Qt4xHb::createReturnClass(new QDomElement(exp), "QDOMELEMENT", true)
#define RQDOMENTITY(exp)                                    Qt4xHb::createReturnClass(new QDomEntity(exp), "QDOMENTITY", true)
#define RQDOMENTITYREFERENCE(exp)                           Qt4xHb::createReturnClass(new QDomEntityReference(exp), "QDOMENTITYREFERENCE", true)
#define RQDOMIMPLEMENTATION(exp)                            Qt4xHb::createReturnClass(new QDomImplementation(exp), "QDOMIMPLEMENTATION", true)
#define RQDOMNAMEDNODEMAP(exp)                              Qt4xHb::createReturnClass(new QDomNamedNodeMap(exp), "QDOMNAMEDNODEMAP", true)
#define RQDOMNODE(exp)                                      Qt4xHb::createReturnClass(new QDomNode(exp), "QDOMNODE", true)
#define RQDOMNODELIST(exp)                                  Qt4xHb::createReturnClass(new QDomNodeList(exp), "QDOMNODELIST", true)
#define RQDOMNOTATION(exp)                                  Qt4xHb::createReturnClass(new QDomNotation(exp), "QDOMNOTATION", true)
#define RQDOMPROCESSINGINSTRUCTION(exp)                     Qt4xHb::createReturnClass(new QDomProcessingInstruction(exp), "QDOMPROCESSINGINSTRUCTION", true)
#define RQDOMTEXT(exp)                                      Qt4xHb::createReturnClass(new QDomText(exp), "QDOMTEXT", true)
#define RQXMLATTRIBUTES(exp)                                Qt4xHb::createReturnClass(new QXmlAttributes(exp), "QXMLATTRIBUTES", true)
#define RQXMLCONTENTHANDLER(exp)                            Qt4xHb::createReturnClass(new QXmlContentHandler(exp), "QXMLCONTENTHANDLER", true)
#define RQXMLDECLHANDLER(exp)                               Qt4xHb::createReturnClass(new QXmlDeclHandler(exp), "QXMLDECLHANDLER", true)
#define RQXMLDEFAULTHANDLER(exp)                            Qt4xHb::createReturnClass(new QXmlDefaultHandler(exp), "QXMLDEFAULTHANDLER", true)
#define RQXMLDTDHANDLER(exp)                                Qt4xHb::createReturnClass(new QXmlDTDHandler(exp), "QXMLDTDHANDLER", true)
#define RQXMLENTITYRESOLVER(exp)                            Qt4xHb::createReturnClass(new QXmlEntityResolver(exp), "QXMLENTITYRESOLVER", true)
#define RQXMLERRORHANDLER(exp)                              Qt4xHb::createReturnClass(new QXmlErrorHandler(exp), "QXMLERRORHANDLER", true)
#define RQXMLINPUTSOURCE(exp)                               Qt4xHb::createReturnClass(new QXmlInputSource(exp), "QXMLINPUTSOURCE", true)
#define RQXMLLEXICALHANDLER(exp)                            Qt4xHb::createReturnClass(new QXmlLexicalHandler(exp), "QXMLLEXICALHANDLER", true)
#define RQXMLLOCATOR(exp)                                   Qt4xHb::createReturnClass(new QXmlLocator(exp), "QXMLLOCATOR", true)
#define RQXMLNAMESPACESUPPORT(exp)                          Qt4xHb::createReturnClass(new QXmlNamespaceSupport(exp), "QXMLNAMESPACESUPPORT", true)
#define RQXMLPARSEEXCEPTION(exp)                            Qt4xHb::createReturnClass(new QXmlParseException(exp), "QXMLPARSEEXCEPTION", true)
#define RQXMLREADER(exp)                                    Qt4xHb::createReturnClass(new QXmlReader(exp), "QXMLREADER", true)
#define RQXMLSIMPLEREADER(exp)                              Qt4xHb::createReturnClass(new QXmlSimpleReader(exp), "QXMLSIMPLEREADER", true)
