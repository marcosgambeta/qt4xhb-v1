...
#define RQAUTHENTICATOR(exp)                                Qt4xHb::createReturnClass(new QAuthenticator(exp), "QAUTHENTICATOR", true)
#define RQHOSTADDRESS(exp)                                  Qt4xHb::createReturnClass(new QHostAddress(exp), "QHOSTADDRESS", true)
#define RQHOSTINFO(exp)                                     Qt4xHb::createReturnClass(new QHostInfo(exp), "QHOSTINFO", true)
#define RQHTTPPART(exp)                                     Qt4xHb::createReturnClass(new QHttpPart(exp), "QHTTPPART", true)
#define RQNETWORKADDRESSENTRY(exp)                          Qt4xHb::createReturnClass(new QNetworkAddressEntry(exp), "QNETWORKADDRESSENTRY", true)
#define RQNETWORKCACHEMETADATA(exp)                         Qt4xHb::createReturnClass(new QNetworkCacheMetaData(exp), "QNETWORKCACHEMETADATA", true)
#define RQNETWORKCONFIGURATION(exp)                         Qt4xHb::createReturnClass(new QNetworkConfiguration(exp), "QNETWORKCONFIGURATION", true)
#define RQNETWORKCOOKIE(exp)                                Qt4xHb::createReturnClass(new QNetworkCookie(exp), "QNETWORKCOOKIE", true)
#define RQNETWORKINTERFACE(exp)                             Qt4xHb::createReturnClass(new QNetworkInterface(exp), "QNETWORKINTERFACE", true)
#define RQNETWORKPROXY(exp)                                 Qt4xHb::createReturnClass(new QNetworkProxy(exp), "QNETWORKPROXY", true)
#define RQNETWORKPROXYFACTORY(exp)                          Qt4xHb::createReturnClass(new QNetworkProxyFactory(exp), "QNETWORKPROXYFACTORY", true)
#define RQNETWORKPROXYQUERY(exp)                            Qt4xHb::createReturnClass(new QNetworkProxyQuery(exp), "QNETWORKPROXYQUERY", true)
#define RQNETWORKREQUEST(exp)                               Qt4xHb::createReturnClass(new QNetworkRequest(exp), "QNETWORKREQUEST", true)
#define RQSSLCERTIFICATE(exp)                               Qt4xHb::createReturnClass(new QSslCertificate(exp), "QSSLCERTIFICATE", true)
#define RQSSLCIPHER(exp)                                    Qt4xHb::createReturnClass(new QSslCipher(exp), "QSSLCIPHER", true)
#define RQSSLCONFIGURATION(exp)                             Qt4xHb::createReturnClass(new QSslConfiguration(exp), "QSSLCONFIGURATION", true)
#define RQSSLERROR(exp)                                     Qt4xHb::createReturnClass(new QSslError(exp), "QSSLERROR", true)
#define RQSSLKEY(exp)                                       Qt4xHb::createReturnClass(new QSslKey(exp), "QSSLKEY", true)
#define RQURLINFO(exp)                                      Qt4xHb::createReturnClass(new QUrlInfo(exp), "QURLINFO", true)
