...
#define OPQGLBUFFER( n, v )                                    ISNIL( n ) ? v : static_cast< QGLBuffer * >( Qt4xHb::itemGetPtr( n ) )
#define OPQGLCOLORMAP( n, v )                                  ISNIL( n ) ? v : static_cast< QGLColormap * >( Qt4xHb::itemGetPtr( n ) )
#define OPQGLCONTEXT( n, v )                                   ISNIL( n ) ? v : static_cast< QGLContext * >( Qt4xHb::itemGetPtr( n ) )
#define OPQGLFORMAT( n, v )                                    ISNIL( n ) ? v : static_cast< QGLFormat * >( Qt4xHb::itemGetPtr( n ) )
#define OPQGLFRAMEBUFFEROBJECT( n, v )                         ISNIL( n ) ? v : static_cast< QGLFramebufferObject * >( Qt4xHb::itemGetPtr( n ) )
#define OPQGLFRAMEBUFFEROBJECTFORMAT( n, v )                   ISNIL( n ) ? v : static_cast< QGLFramebufferObjectFormat * >( Qt4xHb::itemGetPtr( n ) )
#define OPQGLFUNCTIONS( n, v )                                 ISNIL( n ) ? v : static_cast< QGLFunctions * >( Qt4xHb::itemGetPtr( n ) )
#define OPQGLPIXELBUFFER( n, v )                               ISNIL( n ) ? v : static_cast< QGLPixelBuffer * >( Qt4xHb::itemGetPtr( n ) )
#define OPQGLSHADER( n, v )                                    ISNIL( n ) ? v : static_cast< QGLShader * >( Qt4xHb::itemGetPtr( n ) )
#define OPQGLSHADERPROGRAM( n, v )                             ISNIL( n ) ? v : static_cast< QGLShaderProgram * >( Qt4xHb::itemGetPtr( n ) )
#define OPQGLWIDGET( n, v )                                    ISNIL( n ) ? v : static_cast< QGLWidget * >( Qt4xHb::itemGetPtr( n ) )
