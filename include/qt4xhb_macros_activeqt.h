...
#define OPQAXBASE( n, v )                                      ISNIL( n ) ? v : static_cast< QAxBase * >( Qt4xHb::itemGetPtr( n ) )
#define OPQAXBINDABLE( n, v )                                  ISNIL( n ) ? v : static_cast< QAxBindable * >( Qt4xHb::itemGetPtr( n ) )
#define OPQAXFACTORY( n, v )                                   ISNIL( n ) ? v : static_cast< QAxFactory * >( Qt4xHb::itemGetPtr( n ) )
#define OPQAXOBJECT( n, v )                                    ISNIL( n ) ? v : static_cast< QAxObject * >( Qt4xHb::itemGetPtr( n ) )
#define OPQAXSCRIPT( n, v )                                    ISNIL( n ) ? v : static_cast< QAxScript * >( Qt4xHb::itemGetPtr( n ) )
#define OPQAXSCRIPTENGINE( n, v )                              ISNIL( n ) ? v : static_cast< QAxScriptEngine * >( Qt4xHb::itemGetPtr( n ) )
#define OPQAXSCRIPTMANAGER( n, v )                             ISNIL( n ) ? v : static_cast< QAxScriptManager * >( Qt4xHb::itemGetPtr( n ) )
#define OPQAXWIDGET( n, v )                                    ISNIL( n ) ? v : static_cast< QAxWidget * >( Qt4xHb::itemGetPtr( n ) )
