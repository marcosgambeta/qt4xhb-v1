...
#define OPQABSTRACTVIDEOBUFFER( n, v )                         ISNIL( n ) ? v : static_cast< QAbstractVideoBuffer * >( Qt4xHb::itemGetPtr( n ) )
#define OPQABSTRACTVIDEOSURFACE( n, v )                        ISNIL( n ) ? v : static_cast< QAbstractVideoSurface * >( Qt4xHb::itemGetPtr( n ) )
#define OPQAUDIODEVICEINFO( n, v )                             ISNIL( n ) ? v : static_cast< QAudioDeviceInfo * >( Qt4xHb::itemGetPtr( n ) )
#define OPQAUDIOFORMAT( n, v )                                 ISNIL( n ) ? v : static_cast< QAudioFormat * >( Qt4xHb::itemGetPtr( n ) )
#define OPQAUDIOINPUT( n, v )                                  ISNIL( n ) ? v : static_cast< QAudioInput * >( Qt4xHb::itemGetPtr( n ) )
#define OPQAUDIOOUTPUT( n, v )                                 ISNIL( n ) ? v : static_cast< QAudioOutput * >( Qt4xHb::itemGetPtr( n ) )
#define OPQVIDEOFRAME( n, v )                                  ISNIL( n ) ? v : static_cast< QVideoFrame * >( Qt4xHb::itemGetPtr( n ) )
#define OPQVIDEOSURFACEFORMAT( n, v )                          ISNIL( n ) ? v : static_cast< QVideoSurfaceFormat * >( Qt4xHb::itemGetPtr( n ) )
