...
#define OPQGRAPHICSSVGITEM( n, v )                             ISNIL( n ) ? v : static_cast< QGraphicsSvgItem * >( Qt4xHb::itemGetPtr( n ) )
#define OPQSVGGENERATOR( n, v )                                ISNIL( n ) ? v : static_cast< QSvgGenerator * >( Qt4xHb::itemGetPtr( n ) )
#define OPQSVGRENDERER( n, v )                                 ISNIL( n ) ? v : static_cast< QSvgRenderer * >( Qt4xHb::itemGetPtr( n ) )
#define OPQSVGWIDGET( n, v )                                   ISNIL( n ) ? v : static_cast< QSvgWidget * >( Qt4xHb::itemGetPtr( n ) )
