...
#define OPQGRAPHICSWEBVIEW( n, v )                             ISNIL( n ) ? v : static_cast< QGraphicsWebView * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBDATABASE( n, v )                                 ISNIL( n ) ? v : static_cast< QWebDatabase * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBELEMENT( n, v )                                  ISNIL( n ) ? v : static_cast< QWebElement * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBELEMENTCOLLECTION( n, v )                        ISNIL( n ) ? v : static_cast< QWebElementCollection * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBFRAME( n, v )                                    ISNIL( n ) ? v : static_cast< QWebFrame * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBHISTORY( n, v )                                  ISNIL( n ) ? v : static_cast< QWebHistory * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBHISTORYINTERFACE( n, v )                         ISNIL( n ) ? v : static_cast< QWebHistoryInterface * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBHISTORYITEM( n, v )                              ISNIL( n ) ? v : static_cast< QWebHistoryItem * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBHITTESTRESULT( n, v )                            ISNIL( n ) ? v : static_cast< QWebHitTestResult * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBINSPECTOR( n, v )                                ISNIL( n ) ? v : static_cast< QWebInspector * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBPAGE( n, v )                                     ISNIL( n ) ? v : static_cast< QWebPage * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBPLUGINFACTORY( n, v )                            ISNIL( n ) ? v : static_cast< QWebPluginFactory * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBSECURITYORIGIN( n, v )                           ISNIL( n ) ? v : static_cast< QWebSecurityOrigin * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBSETTINGS( n, v )                                 ISNIL( n ) ? v : static_cast< QWebSettings * >( Qt4xHb::itemGetPtr( n ) )
#define OPQWEBVIEW( n, v )                                     ISNIL( n ) ? v : static_cast< QWebView * >( Qt4xHb::itemGetPtr( n ) )
