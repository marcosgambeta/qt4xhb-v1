...
#define OPQDOMATTR( n, v )                                     ISNIL( n ) ? v : static_cast< QDomAttr * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMCDATASECTION( n, v )                             ISNIL( n ) ? v : static_cast< QDomCDATASection * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMCHARACTERDATA( n, v )                            ISNIL( n ) ? v : static_cast< QDomCharacterData * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMCOMMENT( n, v )                                  ISNIL( n ) ? v : static_cast< QDomComment * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMDOCUMENT( n, v )                                 ISNIL( n ) ? v : static_cast< QDomDocument * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMDOCUMENTFRAGMENT( n, v )                         ISNIL( n ) ? v : static_cast< QDomDocumentFragment * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMDOCUMENTTYPE( n, v )                             ISNIL( n ) ? v : static_cast< QDomDocumentType * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMELEMENT( n, v )                                  ISNIL( n ) ? v : static_cast< QDomElement * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMENTITY( n, v )                                   ISNIL( n ) ? v : static_cast< QDomEntity * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMENTITYREFERENCE( n, v )                          ISNIL( n ) ? v : static_cast< QDomEntityReference * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMIMPLEMENTATION( n, v )                           ISNIL( n ) ? v : static_cast< QDomImplementation * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMNAMEDNODEMAP( n, v )                             ISNIL( n ) ? v : static_cast< QDomNamedNodeMap * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMNODE( n, v )                                     ISNIL( n ) ? v : static_cast< QDomNode * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMNODELIST( n, v )                                 ISNIL( n ) ? v : static_cast< QDomNodeList * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMNOTATION( n, v )                                 ISNIL( n ) ? v : static_cast< QDomNotation * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMPROCESSINGINSTRUCTION( n, v )                    ISNIL( n ) ? v : static_cast< QDomProcessingInstruction * >( Qt4xHb::itemGetPtr( n ) )
#define OPQDOMTEXT( n, v )                                     ISNIL( n ) ? v : static_cast< QDomText * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLATTRIBUTES( n, v )                               ISNIL( n ) ? v : static_cast< QXmlAttributes * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLCONTENTHANDLER( n, v )                           ISNIL( n ) ? v : static_cast< QXmlContentHandler * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLDECLHANDLER( n, v )                              ISNIL( n ) ? v : static_cast< QXmlDeclHandler * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLDEFAULTHANDLER( n, v )                           ISNIL( n ) ? v : static_cast< QXmlDefaultHandler * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLDTDHANDLER( n, v )                               ISNIL( n ) ? v : static_cast< QXmlDTDHandler * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLENTITYRESOLVER( n, v )                           ISNIL( n ) ? v : static_cast< QXmlEntityResolver * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLERRORHANDLER( n, v )                             ISNIL( n ) ? v : static_cast< QXmlErrorHandler * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLINPUTSOURCE( n, v )                              ISNIL( n ) ? v : static_cast< QXmlInputSource * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLLEXICALHANDLER( n, v )                           ISNIL( n ) ? v : static_cast< QXmlLexicalHandler * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLLOCATOR( n, v )                                  ISNIL( n ) ? v : static_cast< QXmlLocator * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLNAMESPACESUPPORT( n, v )                         ISNIL( n ) ? v : static_cast< QXmlNamespaceSupport * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLPARSEEXCEPTION( n, v )                           ISNIL( n ) ? v : static_cast< QXmlParseException * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLREADER( n, v )                                   ISNIL( n ) ? v : static_cast< QXmlReader * >( Qt4xHb::itemGetPtr( n ) )
#define OPQXMLSIMPLEREADER( n, v )                             ISNIL( n ) ? v : static_cast< QXmlSimpleReader * >( Qt4xHb::itemGetPtr( n ) )
