...
FUNCTION hbmk_plugin_qt(hbmk)
   ...
   CASE "pre_c"
      ...
      run("moc source\QtCore\QFutureWatcherBaseSlots.hpp -o source\QtCore\QFutureWatcherBaseSlotsMoc.cpp")
      ...
      run("moc source\QtCore\QSocketNotifierSlots.hpp -o source\QtCore\QSocketNotifierSlotsMoc.cpp")
   ...
   CASE "post_all"
      ...
      run("del source\QtCore\QFutureWatcherBaseSlotsMoc.cpp")
      ...
      run("del source\QtCore\QSocketNotifierSlotsMoc.cpp")
