...
#define GET_PTR_FROM_SELF(p) QGLWidget *p = qobject_cast<QGLWidget *>(Qt4xHb::getQObjectPointerFromSelfItem())
...
{
  if (ISBETWEEN(3, 5) && HB_ISNUM(1) && HB_ISNUM(2) && HB_ISCHAR(3) && (ISQFONT(4) || HB_ISNIL(4)) && ISNUMORNIL(5)) {
