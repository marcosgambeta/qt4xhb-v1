...
{
  QGLWidget * obj = (QGLWidget *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
...
HB_FUNC_STATIC( QGLWIDGET_COLORMAP )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnClass( ptr, "QGLCOLORMAP", false );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QGLWIDGET_CONTEXT )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnClass( ptr, "QGLCONTEXT", false );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QGLWIDGET_FORMAT )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnClass( ptr, "QGLFORMAT", true );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QGLWIDGET_QGLCLEARCOLOR )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      obj->qglClearColor( ISOBJECT(1)? *(QColor *) Qt4xHb::_qt4xhb_itemGetPtr(1) : QColor(hb_parc(1)) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QGLWIDGET_QGLCOLOR )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      obj->qglColor( ISOBJECT(1)? *(QColor *) Qt4xHb::_qt4xhb_itemGetPtr(1) : QColor(hb_parc(1)) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
void QGLWidget_renderText1()
{
  ...
  if( obj )
  {
    obj->renderText( PINT(1), PINT(2), PQSTRING(3), ISNIL(4)? QFont() : *(QFont *) Qt4xHb::_qt4xhb_itemGetPtr(4), OPINT(5,2000) );
  }
...
void QGLWidget_renderText2()
{
  ...
  if( obj )
  {
    obj->renderText( PDOUBLE(1), PDOUBLE(2), PDOUBLE(3), PQSTRING(4), ISNIL(5)? QFont() : *(QFont *) Qt4xHb::_qt4xhb_itemGetPtr(5), OPINT(6,2000) );
  }
