...
void SlotsQAxScript::entered ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "entered()" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQAxScript::error ( int code, const QString & description, int sourcePosition, const QString & sourceText )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "error(int,QString,int,QString)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        ...
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 5, psender, pcode, pdescription, psourcePosition, psourceText );
        hb_itemRelease( psender );
...
void SlotsQAxScript::finished ( const QVariant & result )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "finished(QVariant)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM presult = hb_itemPutPtr( NULL, (QVariant *) &result );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, presult );
        hb_itemRelease( psender );
...
void SlotsQAxScript::finished ( int code, const QString & source, const QString & description, const QString & help )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "finished(int,QString,QString,QString)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pcode = hb_itemPutNI( NULL, code );
        ...
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 5, psender, pcode, psource, pdescription, phelp );
        hb_itemRelease( psender );
        hb_itemRelease( pcode );
