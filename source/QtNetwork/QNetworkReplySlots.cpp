...
{
  QNetworkReply_release_codeblocks();
}
void SlotsQNetworkReply::downloadProgress ( qint64 bytesReceived, qint64 bytesTotal )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "downloadProgress(qint64,qint64)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pbytesReceived = hb_itemPutNI( NULL, bytesReceived );
        PHB_ITEM pbytesTotal = hb_itemPutNI( NULL, bytesTotal );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 3, psender, pbytesReceived, pbytesTotal );
...
void SlotsQNetworkReply::error ( QNetworkReply::NetworkError code )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "error(QNetworkReply::NetworkError)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pcode = hb_itemPutNI( NULL, (int) code );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pcode );
        hb_itemRelease( psender );
...
void SlotsQNetworkReply::metaDataChanged ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "metaDataChanged()" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 1, psender );
        hb_itemRelease( psender );
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "sslErrors(QList<QSslError>)" ) && ( (bool) list4.at(i) == true ) )
      {
        ...
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, perrors );
        hb_itemRelease( psender );
...
void SlotsQNetworkReply::uploadProgress ( qint64 bytesSent, qint64 bytesTotal )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "uploadProgress(qint64,qint64)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pbytesSent = hb_itemPutNI( NULL, bytesSent );
        PHB_ITEM pbytesTotal = hb_itemPutNI( NULL, bytesTotal );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 3, psender, pbytesSent, pbytesTotal );
        hb_itemRelease( psender );
