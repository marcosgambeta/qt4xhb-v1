...
{
  QSslSocket * obj = (QSslSocket *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
...
HB_FUNC_STATIC( QSSLSOCKET_PRIVATEKEY )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnClass( ptr, "QSSLKEY", true );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QSSLSOCKET_SESSIONCIPHER )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnClass( ptr, "QSSLCIPHER", true );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
void QSslSocket_setPrivateKey2()
{
  ...
  if( obj )
  {
    obj->setPrivateKey( PQSTRING(1), ISNIL(2)? (QSsl::KeyAlgorithm) QSsl::Rsa : (QSsl::KeyAlgorithm) hb_parni(2), ISNIL(3)? (QSsl::EncodingFormat) QSsl::Pem : (QSsl::EncodingFormat) hb_parni(3), ISNIL(4)? QByteArray() : *(QByteArray *) Qt4xHb::_qt4xhb_itemGetPtr(4) );
  }
