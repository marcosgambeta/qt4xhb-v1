...
HB_FUNC_STATIC( QTCPSERVER_LISTEN )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      RBOOL( obj->listen( ISNIL(1)? QHostAddress::Any : *(QHostAddress *) Qt4xHb::_qt4xhb_itemGetPtr(1), OPQUINT16(2,0) ) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QTCPSERVER_NEXTPENDINGCONNECTION )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnQObjectClass( ptr, "QTCPSOCKET" );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
