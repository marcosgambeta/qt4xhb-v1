...
{
  QAbstractSocket_release_codeblocks();
}
void SlotsQAbstractSocket::connected ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "connected()" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQAbstractSocket::disconnected ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "disconnected()" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 1, psender );
        hb_itemRelease( psender );
...
void SlotsQAbstractSocket::error ( QAbstractSocket::SocketError socketError )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "error(QAbstractSocket::SocketError)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM psocketError = hb_itemPutNI( NULL, (int) socketError );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, psocketError );
        hb_itemRelease( psender );
...
void SlotsQAbstractSocket::hostFound ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "hostFound()" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 1, psender );
        hb_itemRelease( psender );
...
void SlotsQAbstractSocket::stateChanged ( QAbstractSocket::SocketState socketState )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "stateChanged(QAbstractSocket::SocketState)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM psocketState = hb_itemPutNI( NULL, (int) socketState );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, psocketState );
        hb_itemRelease( psender );
