...
{
  QLocalSocket_release_codeblocks();
}
...
void SlotsQLocalSocket::error ( QLocalSocket::LocalSocketError socketError )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "error(QLocalSocket::LocalSocketError)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
...
void SlotsQLocalSocket::stateChanged ( QLocalSocket::LocalSocketState socketState )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "stateChanged(QLocalSocket::LocalSocketState)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
