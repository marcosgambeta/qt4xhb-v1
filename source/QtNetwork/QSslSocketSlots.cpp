...
void SlotsQSslSocket::encrypted ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "encrypted()" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQSslSocket::encryptedBytesWritten ( qint64 written )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "encryptedBytesWritten(qint64)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pwritten = hb_itemPutNI( NULL, written );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pwritten );
        hb_itemRelease( psender );
...
void SlotsQSslSocket::modeChanged ( QSslSocket::SslMode mode )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "modeChanged(QSslSocket::SslMode)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pmode = hb_itemPutNI( NULL, (int) mode );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pmode );
        hb_itemRelease( psender );
...
void SlotsQSslSocket::peerVerifyError ( const QSslError & error )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "peerVerifyError(QSslError)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
