...
void SlotsQProcess::error ( QProcess::ProcessError error )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "error(QProcess::ProcessError)" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQProcess::finished ( int exitCode, QProcess::ExitStatus exitStatus )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "finished(int,QProcess::ExitStatus)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pexitCode = hb_itemPutNI( NULL, exitCode );
        PHB_ITEM pexitStatus = hb_itemPutNI( NULL, (int) exitStatus );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 3, psender, pexitCode, pexitStatus );
        hb_itemRelease( psender );
...
void SlotsQProcess::readyReadStandardError ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "readyReadStandardError()" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
...
void SlotsQProcess::readyReadStandardOutput ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "readyReadStandardOutput()" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 1, psender );
        hb_itemRelease( psender );
...
void SlotsQProcess::stateChanged ( QProcess::ProcessState newState )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "stateChanged(QProcess::ProcessState)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
