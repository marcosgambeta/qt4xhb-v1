...
METHOD newFrom (p) CLASS QAbstractExtensionFactory
   IF valtype(p) == "O"
      ::pointer := p:pointer
      ::self_destruction := .f.
   ELSEIF valtype(p) == "P"
...
METHOD newFromObject (p) CLASS QAbstractExtensionFactory
   ::pointer := p:pointer
   ::self_destruction := .f.
RETURN self

METHOD newFromPointer (p) CLASS QAbstractExtensionFactory
   ::pointer := p
   ::self_destruction := .f.
RETURN self

METHOD selfDestruction () CLASS QAbstractExtensionFactory
RETURN ::self_destruction

METHOD setSelfDestruction (p) CLASS QAbstractExtensionFactory
   IF valtype(p) == "L"
      ::self_destruction := p
   ENDIF
RETURN self
