...
void QXmlQuery_new4()
{
  QXmlQuery * o = new QXmlQuery( (QXmlQuery::QueryLanguage) hb_parni(1), ISNIL(2)? QXmlNamePool() : *(QXmlNamePool *) Qt4xHb::_qt4xhb_itemGetPtr(2) );
  Qt4xHb::_qt4xhb_returnNewObject( o, true );
}
...
{
  QXmlQuery * obj = (QXmlQuery *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
...
HB_FUNC_STATIC( QXMLQUERY_INITIALTEMPLATENAME )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnClass( ptr, "QXMLNAME", true );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
void QXmlQuery_setQuery1()
{
  ...
  if( obj )
  {
    obj->setQuery( PQIODEVICE(1), ISNIL(2)? QUrl() : *(QUrl *) Qt4xHb::_qt4xhb_itemGetPtr(2) );
  }
...
void QXmlQuery_setQuery2()
{
  ...
  if( obj )
  {
    obj->setQuery( *PQURL(1), ISNIL(2)? QUrl() : *(QUrl *) Qt4xHb::_qt4xhb_itemGetPtr(2) );
  }
...
void QXmlQuery_setQuery3()
{
  ...
  if( obj )
  {
    obj->setQuery( PQSTRING(1), ISNIL(2)? QUrl() : *(QUrl *) Qt4xHb::_qt4xhb_itemGetPtr(2) );
  }
