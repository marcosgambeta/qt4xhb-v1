...
{
  QAbstractMessageHandler * obj = (QAbstractMessageHandler *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
...
HB_FUNC_STATIC( QABSTRACTMESSAGEHANDLER_MESSAGE )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      obj->message( (QtMsgType) hb_parni(1), PQSTRING(2), ISNIL(3)? QUrl() : *(QUrl *) Qt4xHb::_qt4xhb_itemGetPtr(3), ISNIL(4)? QSourceLocation() : *(QSourceLocation *) Qt4xHb::_qt4xhb_itemGetPtr(4) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
