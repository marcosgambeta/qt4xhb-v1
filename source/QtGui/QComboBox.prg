...
void QComboBox_addItem1()
{
  ...
  if( obj )
  {
    obj->addItem( PQSTRING( 1 ), ISNIL( 2 ) ? QVariant() : *static_cast< QVariant * >( Qt4xHb::itemGetPtr( 2 ) ) );
  }
...
void QComboBox_addItem2()
{
  ...
  if( obj )
  {
    obj->addItem( ISOBJECT( 1 ) ? *static_cast< QIcon * >( Qt4xHb::itemGetPtr( 1 ) ) : QIcon( hb_parc( 1 ) ), PQSTRING( 2 ), ISNIL( 3 ) ? QVariant() : *static_cast< QVariant * >( Qt4xHb::itemGetPtr( 3 ) ) );
  }
...
void QComboBox_insertItem1()
{
  ...
  if( obj )
  {
    obj->insertItem( PINT( 1 ), PQSTRING( 2 ), ISNIL( 3 ) ? QVariant() : *static_cast< QVariant * >( Qt4xHb::itemGetPtr( 3 ) ) );
  }
...
void QComboBox_insertItem2()
{
  ...
  if( obj )
  {
    obj->insertItem( PINT( 1 ), ISOBJECT( 2 ) ? *static_cast< QIcon * >( Qt4xHb::itemGetPtr( 2 ) ) : QIcon( hb_parc( 2 ) ), PQSTRING( 3 ), ISNIL( 4 ) ? QVariant() : *static_cast< QVariant * >( Qt4xHb::itemGetPtr( 4 ) ) );
  }
...
HB_FUNC_STATIC( QCOMBOBOX_SETITEMICON )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      obj->setItemIcon( PINT( 1 ), ISOBJECT( 2 ) ? *static_cast< QIcon * >( Qt4xHb::itemGetPtr( 2 ) ) : QIcon( hb_parc( 2 ) ) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
