...
void QMovie_new2()
{
  QMovie * o = new QMovie( PQIODEVICE(1), ISNIL(2)? QByteArray() : *(QByteArray *) Qt4xHb::itemGetPtr(2), OPQOBJECT(3,0) );
  Qt4xHb::returnNewObject( o, false );
}
...
void QMovie_new3()
{
  QMovie * o = new QMovie( PQSTRING(1), ISNIL(2)? QByteArray() : *(QByteArray *) Qt4xHb::itemGetPtr(2), OPQOBJECT(3,0) );
  Qt4xHb::returnNewObject( o, false );
}
