...
{
  QGraphicsEllipseItem * o = new QGraphicsEllipseItem( ISNIL(1)? 0 : (QGraphicsItem *) Qt4xHb::_qt4xhb_itemGetPtr(1) );
...
{
  QGraphicsEllipseItem * o = new QGraphicsEllipseItem( *PQRECTF(1), ISNIL(2)? 0 : (QGraphicsItem *) Qt4xHb::_qt4xhb_itemGetPtr(2) );
  Qt4xHb::_qt4xhb_returnNewObject( o, true );
}
...
{
  QGraphicsEllipseItem * o = new QGraphicsEllipseItem( PQREAL(1), PQREAL(2), PQREAL(3), PQREAL(4), ISNIL(5)? 0 : (QGraphicsItem *) Qt4xHb::_qt4xhb_itemGetPtr(5) );
  Qt4xHb::_qt4xhb_returnNewObject( o, true );
}
...
{
  QGraphicsEllipseItem * obj = (QGraphicsEllipseItem *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
