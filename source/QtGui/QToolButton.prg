...
#define GET_PTR_FROM_SELF(p) QToolButton *p = qobject_cast<QToolButton *>(Qt4xHb::getQObjectPointerFromSelfItem())
...
#define CONNECT_SIGNAL(signal) QToolButtonSlots_connect_signal(signal, signal)
