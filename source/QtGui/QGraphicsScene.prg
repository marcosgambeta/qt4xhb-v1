...
#define GET_PTR_FROM_SELF(p) QGraphicsScene *p = qobject_cast<QGraphicsScene *>(Qt4xHb::getQObjectPointerFromSelfItem())
  ...
  if (obj != NULL) {
    ...
    if (ISBETWEEN(1, 2) && ISQWIDGET(1) && ISNUMORNIL(2)) {
      ...
      QGraphicsProxyWidget *ptr =
          obj->addWidget(PQWIDGET(1), HB_ISNIL(2) ? static_cast<Qt::WindowFlags>(0) : PQT_WINDOWFLAGS(2));
  ...
  if (obj != NULL) {
    ...
    if (ISBETWEEN(1, 2) && ISQGRAPHICSITEM(1) && ISNUMORNIL(2)) {
      ...
      QList<QGraphicsItem *> list = obj->collidingItems(
          PQGRAPHICSITEM(1),
          HB_ISNIL(2) ? static_cast<Qt::ItemSelectionMode>(Qt::IntersectsItemShape) : PQT_ITEMSELECTIONMODE(2));
...
HB_FUNC_STATIC(QGRAPHICSSCENE_ITEMS)
{
  if (ISNUMPAR(0)) {
    ...
    if (obj != NULL) {
      QList<QGraphicsItem *> list = obj->items(PQT_SORTORDER(1));
      PHB_DYNS pDynSym = hb_dynsymFindName("QGRAPHICSITEM");
      PHB_ITEM pArray = hb_itemArrayNew(0);
      if (pDynSym != NULL) {
        const int count = list.count();
    ...
    if (obj != NULL) {
      QList<QGraphicsItem *> list =
          obj->items(*PQPOINTF(1), PQT_ITEMSELECTIONMODE(2), PQT_SORTORDER(3),
    ...
    if (obj != NULL) {
      QList<QGraphicsItem *> list =
          obj->items(PQREAL(1), PQREAL(2), PQREAL(3), PQREAL(4), PQT_ITEMSELECTIONMODE(5), PQT_SORTORDER(6),
    ...
    if (obj != NULL) {
      QList<QGraphicsItem *> list =
          obj->items(*PQRECTF(1), PQT_ITEMSELECTIONMODE(2), PQT_SORTORDER(3),
                     HB_ISNIL(4) ? QTransform() : *static_cast<QTransform *>(Qt4xHb::itemGetPtr(4)));
      PHB_DYNS pDynSym = hb_dynsymFindName("QGRAPHICSITEM");
      PHB_ITEM pArray = hb_itemArrayNew(0);
      if (pDynSym != NULL) {
    ...
    if (obj != NULL) {
      QList<QGraphicsItem *> list =
          obj->items(*PQPOLYGONF(1), PQT_ITEMSELECTIONMODE(2), PQT_SORTORDER(3),
                     HB_ISNIL(4) ? QTransform() : *static_cast<QTransform *>(Qt4xHb::itemGetPtr(4)));
      PHB_DYNS pDynSym = hb_dynsymFindName("QGRAPHICSITEM");
      PHB_ITEM pArray = hb_itemArrayNew(0);
      if (pDynSym != NULL) {
    ...
    if (obj != NULL) {
      QList<QGraphicsItem *> list =
          obj->items(*PQPAINTERPATH(1), PQT_ITEMSELECTIONMODE(2), PQT_SORTORDER(3),
                     HB_ISNIL(4) ? QTransform() : *static_cast<QTransform *>(Qt4xHb::itemGetPtr(4)));
      PHB_DYNS pDynSym = hb_dynsymFindName("QGRAPHICSITEM");
      PHB_ITEM pArray = hb_itemArrayNew(0);
      if (pDynSym != NULL) {
  ...
  if (obj != NULL) {
    ...
    if (ISBETWEEN(1, 2) && ISQGRAPHICSITEM(1) && ISNUMORNIL(2)) {
      ...
      obj->setFocusItem(PQGRAPHICSITEM(1),
                        HB_ISNIL(2) ? static_cast<Qt::FocusReason>(Qt::OtherFocusReason) : PQT_FOCUSREASON(2));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
