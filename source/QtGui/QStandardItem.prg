...
{
  QStandardItem * obj = new QStandardItem( ISOBJECT(1)? *(QIcon *) Qt4xHb::itemGetPtr(1) : QIcon(hb_parc(1)), PQSTRING(2) );
  Qt4xHb::returnNewObject( obj, false );
}
...
{
  QStandardItem * obj = (QStandardItem *) Qt4xHb::itemGetPtrStackSelfItem();
