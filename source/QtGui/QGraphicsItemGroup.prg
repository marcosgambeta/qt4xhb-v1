...
HB_FUNC_STATIC( QGRAPHICSITEMGROUP_NEW )
{
  ...
  {
    QGraphicsItemGroup * o = new QGraphicsItemGroup( ISNIL(1)? 0 : (QGraphicsItem *) _qt4xhb_itemGetPtr(1) );
...
{
  QGraphicsItemGroup * obj = (QGraphicsItemGroup *) _qt4xhb_itemGetPtrStackSelfItem();
