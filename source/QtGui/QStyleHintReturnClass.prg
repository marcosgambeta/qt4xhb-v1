...
METHOD newFrom (p) CLASS QStyleHintReturn
   IF valtype(p) == "O"
      ::pointer := p:pointer
      ::self_destruction := .f.
   ELSEIF valtype(p) == "P"
...
METHOD newFromObject (p) CLASS QStyleHintReturn
   ::pointer := p:pointer
   ::self_destruction := .f.
RETURN self

METHOD newFromPointer (p) CLASS QStyleHintReturn
   ::pointer := p
   ::self_destruction := .f.
RETURN self

METHOD selfDestruction () CLASS QStyleHintReturn
RETURN ::self_destruction

METHOD setSelfDestruction (p) CLASS QStyleHintReturn
   IF valtype(p) == "L"
      ::self_destruction := p
   ENDIF
RETURN self
