...
HB_FUNC_STATIC(QPLATFORMWINDOWFORMAT_NEW)
{
  if (ISNUMPAR(0)) {
    ...
    QPlatformWindowFormat *obj = new QPlatformWindowFormat(PQPLATFORMWINDOWFORMAT_FORMATOPTIONS(1));
    Qt4xHb::returnNewObject(obj, true);
...
HB_FUNC_STATIC(QPLATFORMWINDOWFORMAT_SETOPTION)
{
  ...
  if (obj != NULL) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setOption(PQPLATFORMWINDOWFORMAT_FORMATOPTIONS(1));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QPLATFORMWINDOWFORMAT_SETWINDOWAPI)
{
  ...
  if (obj != NULL) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      obj->setWindowApi(PQPLATFORMWINDOWFORMAT_WINDOWAPI(1));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QPLATFORMWINDOWFORMAT_TESTOPTION)
{
  ...
  if (obj != NULL) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      RBOOL(obj->testOption(PQPLATFORMWINDOWFORMAT_FORMATOPTIONS(1)));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
