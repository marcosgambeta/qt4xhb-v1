...
{
  QToolBar * obj = static_cast< QToolBar * >( Qt4xHb::itemGetPtrStackSelfItem() );
...
void QToolBar_addAction5()
{
  ...
  if( obj )
  {
    QAction * ptr = obj->addAction( ISOBJECT( 1 ) ? *static_cast< QIcon * >( Qt4xHb::itemGetPtr( 1 ) ) : QIcon( hb_parc( 1 ) ), PQSTRING( 2 ), PQOBJECT( 3 ), PCONSTCHAR( 4 ) );
    Qt4xHb::createReturnQObjectClass( ptr, "QACTION" );
  }
}
