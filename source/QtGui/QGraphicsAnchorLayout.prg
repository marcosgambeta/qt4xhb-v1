  ...
  if (obj != NULL) {
    ...
    if (ISBETWEEN(2, 3) && ISQGRAPHICSLAYOUTITEM(1) && ISQGRAPHICSLAYOUTITEM(2) && ISNUMORNIL(3)) {
      ...
      obj->addAnchors(PQGRAPHICSLAYOUTITEM(1), PQGRAPHICSLAYOUTITEM(2),
                      HB_ISNIL(3) ? static_cast<Qt::Orientations>(Qt::Horizontal | Qt::Vertical) : PQT_ORIENTATIONS(3));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
#endif
      QGraphicsAnchor *ptr =
          obj->anchor(PQGRAPHICSLAYOUTITEM(1), PQT_ANCHORPOINT(2), PQGRAPHICSLAYOUTITEM(3), PQT_ANCHORPOINT(4));
      Qt4xHb::createReturnQObjectClass(ptr, "QGRAPHICSANCHOR");
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
