...
METHOD newFrom (p) CLASS QVector2D
   IF valtype(p) == "O"
      ::pointer := p:pointer
      ::self_destruction := .f.
   ELSEIF valtype(p) == "P"
...
METHOD newFromObject (p) CLASS QVector2D
   ::pointer := p:pointer
   ::self_destruction := .f.
RETURN self

METHOD newFromPointer (p) CLASS QVector2D
   ::pointer := p
   ::self_destruction := .f.
RETURN self

METHOD selfDestruction () CLASS QVector2D
RETURN ::self_destruction

METHOD setSelfDestruction (p) CLASS QVector2D
   IF valtype(p) == "L"
      ::self_destruction := p
   ENDIF
RETURN self
