  ...
  if (ISBETWEEN(1, 2) && HB_ISNUM(1) && ISNUMORNIL(2)) {
    ...
    if (obj != NULL) {
      QImage *ptr = new QImage(
          obj->convertToFormat(PQIMAGE_FORMAT(1), HB_ISNIL(2) ? static_cast<Qt::ImageConversionFlags>(Qt::AutoColor)
    ...
    if (obj != NULL) {
      ...
      QImage *ptr = new QImage(obj->convertToFormat(PQIMAGE_FORMAT(1), par2,
...
#endif
      QImage *ptr = new QImage(obj->createAlphaMask(HB_ISNIL(1) ? static_cast<Qt::ImageConversionFlags>(Qt::AutoColor)
...
HB_FUNC_STATIC(QIMAGE_CREATEMASKFROMCOLOR)
{
  ...
  if (obj != NULL) {
    ...
    if (ISBETWEEN(1, 2) && HB_ISNUM(1) && ISNUMORNIL(2)) {
#endif
      QImage *ptr = new QImage(obj->createMaskFromColor(
          PQRGB(1), HB_ISNIL(2) ? static_cast<Qt::MaskMode>(Qt::MaskInColor) : PQT_MASKMODE(2)));
      Qt4xHb::createReturnClass(ptr, "QIMAGE", true);
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
