...
{
  QGraphicsPolygonItem * o = new QGraphicsPolygonItem( ISNIL(1)? 0 : (QGraphicsItem *) Qt4xHb::_qt4xhb_itemGetPtr(1) );
...
{
  QGraphicsPolygonItem * o = new QGraphicsPolygonItem( *PQPOLYGONF(1), ISNIL(2)? 0 : (QGraphicsItem *) Qt4xHb::_qt4xhb_itemGetPtr(2) );
  Qt4xHb::_qt4xhb_returnNewObject( o, true );
}
...
{
  QGraphicsPolygonItem * obj = (QGraphicsPolygonItem *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
