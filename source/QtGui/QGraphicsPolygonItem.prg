...
{
  QGraphicsPolygonItem * o = new QGraphicsPolygonItem( ISNIL(1)? 0 : (QGraphicsItem *) _qt4xhb_itemGetPtr(1) );
...
{
  QGraphicsPolygonItem * o = new QGraphicsPolygonItem( *PQPOLYGONF(1), ISNIL(2)? 0 : (QGraphicsItem *) _qt4xhb_itemGetPtr(2) );
  _qt4xhb_returnNewObject( o, true );
}
...
{
  QGraphicsPolygonItem * obj = (QGraphicsPolygonItem *) _qt4xhb_itemGetPtrStackSelfItem();
