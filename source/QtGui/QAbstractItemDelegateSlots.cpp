...
{
  QAbstractItemDelegate_release_codeblocks();
}
void SlotsQAbstractItemDelegate::closeEditor ( QWidget * editor, QAbstractItemDelegate::EndEditHint hint )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "closeEditor(QWidget*,QAbstractItemDelegate::EndEditHint)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM peditor = hb_itemPutPtr( NULL, (QWidget *) editor );
        PHB_ITEM phint = hb_itemPutNI( NULL, (int) hint );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 3, psender, peditor, phint );
...
void SlotsQAbstractItemDelegate::commitData ( QWidget * editor )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "commitData(QWidget*)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM peditor = hb_itemPutPtr( NULL, (QWidget *) editor );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, peditor );
        hb_itemRelease( psender );
        hb_itemRelease( peditor );
      }
    }
...
void SlotsQAbstractItemDelegate::sizeHintChanged ( const QModelIndex & index )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "sizeHintChanged(QModelIndex)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pindex = hb_itemPutPtr( NULL, (QModelIndex *) &index );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pindex );
        hb_itemRelease( psender );
