...
{
  QGraphicsItem * obj = (QGraphicsItem *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
...
void QGraphicsItem_ensureVisible1()
{
  ...
  if( obj )
  {
    obj->ensureVisible( ISNIL(1)? QRectF() : *(QRectF *) Qt4xHb::_qt4xhb_itemGetPtr(1), OPINT(2,50), OPINT(3,50) );
  }
...
HB_FUNC_STATIC( QGRAPHICSITEM_PARENTOBJECT )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnQObjectClass( ptr, "QGRAPHICSOBJECT" );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QGRAPHICSITEM_SCENE )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnQObjectClass( ptr, "QGRAPHICSSCENE" );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QGRAPHICSITEM_SCROLL )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      obj->scroll( PQREAL(1), PQREAL(2), ISNIL(3)? QRectF() : *(QRectF *) Qt4xHb::_qt4xhb_itemGetPtr(3) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QGRAPHICSITEM_SETCACHEMODE )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      obj->setCacheMode( (QGraphicsItem::CacheMode) hb_parni(1), ISNIL(2)? QSize() : *(QSize *) Qt4xHb::_qt4xhb_itemGetPtr(2) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
