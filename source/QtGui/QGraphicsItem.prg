...
{
  QGraphicsItem * obj = (QGraphicsItem *) _qt4xhb_itemGetPtrStackSelfItem();
...
HB_FUNC_STATIC( QGRAPHICSITEM_SCROLL )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      obj->scroll( PQREAL(1), PQREAL(2), ISNIL(3)? QRectF() : *(QRectF *) _qt4xhb_itemGetPtr(3) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QGRAPHICSITEM_SETCACHEMODE )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      obj->setCacheMode( (QGraphicsItem::CacheMode) hb_parni(1), ISNIL(2)? QSize() : *(QSize *) _qt4xhb_itemGetPtr(2) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
