...
{
  QGraphicsPathItem * o = new QGraphicsPathItem( ISNIL(1)? 0 : (QGraphicsItem *) Qt4xHb::_qt4xhb_itemGetPtr(1) );
...
{
  QGraphicsPathItem * o = new QGraphicsPathItem( *PQPAINTERPATH(1), ISNIL(2)? 0 : (QGraphicsItem *) Qt4xHb::_qt4xhb_itemGetPtr(2) );
  Qt4xHb::_qt4xhb_returnNewObject( o, true );
}
...
{
  QGraphicsPathItem * obj = (QGraphicsPathItem *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
