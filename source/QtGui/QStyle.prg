...
HB_FUNC_STATIC( QSTYLE_COMBINEDLAYOUTSPACING )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      RINT( obj->combinedLayoutSpacing( ( QSizePolicy::ControlTypes ) hb_parni( 1 ), ( QSizePolicy::ControlTypes ) hb_parni( 2 ), ( Qt::Orientation ) hb_parni( 3 ), HB_ISNIL( 4 ) ? 0 : static_cast< QStyleOption * >( Qt4xHb::itemGetPtr( 4 ) ), OPQWIDGET( 5, 0 ) ) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QSTYLE_LAYOUTSPACING )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      RINT( obj->layoutSpacing( ( QSizePolicy::ControlType ) hb_parni( 1 ), ( QSizePolicy::ControlType ) hb_parni( 2 ), ( Qt::Orientation ) hb_parni( 3 ), HB_ISNIL( 4 ) ? 0 : static_cast< QStyleOption * >( Qt4xHb::itemGetPtr( 4 ) ), OPQWIDGET( 5, 0 ) ) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
