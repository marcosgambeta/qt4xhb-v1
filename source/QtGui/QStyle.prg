...
#endif
      RINT(obj->combinedLayoutSpacing(PQSIZEPOLICY_CONTROLTYPES(1), PQSIZEPOLICY_CONTROLTYPES(2), PQT_ORIENTATION(3),
                                      HB_ISNIL(4) ? 0 : static_cast<QStyleOption *>(Qt4xHb::itemGetPtr(4)),
                                      OPQWIDGET(5, 0)));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
...
#endif
      RQRECT(obj->alignedRect(PQT_LAYOUTDIRECTION(1), PQT_ALIGNMENT(2), *PQSIZE(3), *PQRECT(4)));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
