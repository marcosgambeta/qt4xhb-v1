...
{
  QStackedLayout_release_codeblocks();
}
void SlotsQStackedLayout::setCurrentIndex ( int index )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "setCurrentIndex(int)" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQStackedLayout::setCurrentWidget ( QWidget * widget )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "setCurrentWidget(QWidget*)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
