...
#define GET_PTR_FROM_SELF(p) QKeySequence *p = static_cast<QKeySequence *>(Qt4xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QKEYSEQUENCE_NEW)
{
  if (ISNUMPAR(0)) {
    ...
    QKeySequence *obj = new QKeySequence(PQSTRING(1), PQKEYSEQUENCE_SEQUENCEFORMAT(2));
    Qt4xHb::returnNewObject(obj, true);
  } else if (ISNUMPAR(1) && HB_ISNUM(1)) {
    // QKeySequence(QKeySequence::StandardKey key)
    QKeySequence *obj = new QKeySequence(PQKEYSEQUENCE_STANDARDKEY(1));
    Qt4xHb::returnNewObject(obj, true);
...
#endif
    QKeySequence *ptr = new QKeySequence(QKeySequence::fromString(
...
#endif
    QList<QKeySequence> list = QKeySequence::keyBindings(PQKEYSEQUENCE_STANDARDKEY(1));
