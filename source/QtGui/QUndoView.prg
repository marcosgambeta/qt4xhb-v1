...
{
  QUndoView * obj = (QUndoView *) _qt4xhb_itemGetPtrStackSelfItem();
...
HB_FUNC_STATIC( QUNDOVIEW_GROUP )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      _qt4xhb_createReturnQObjectClass( ptr, "QUNDOGROUP" );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QUNDOVIEW_SETCLEANICON )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      obj->setCleanIcon( ISOBJECT(1)? *(QIcon *) _qt4xhb_itemGetPtr(1) : QIcon(hb_parc(1)) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
