...
{
  QTextCharFormat * obj = (QTextCharFormat *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
...
HB_FUNC_STATIC( QTEXTCHARFORMAT_SETUNDERLINECOLOR )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      obj->setUnderlineColor( ISOBJECT(1)? *(QColor *) Qt4xHb::_qt4xhb_itemGetPtr(1) : QColor(hb_parc(1)) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
