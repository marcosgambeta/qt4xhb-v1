...
{
  QImageIOPlugin * obj = (QImageIOPlugin *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
...
HB_FUNC_STATIC( QIMAGEIOPLUGIN_CREATE )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      QImageIOHandler * ptr = obj->create( PQIODEVICE(1), ISNIL(2)? QByteArray() : *(QByteArray *) Qt4xHb::_qt4xhb_itemGetPtr(2) );
      Qt4xHb::_qt4xhb_createReturnClass( ptr, "QIMAGEIOHANDLER", false );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
