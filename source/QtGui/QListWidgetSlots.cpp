...
{
  QListWidget_release_codeblocks();
}
void SlotsQListWidget::currentItemChanged ( QListWidgetItem * current, QListWidgetItem * previous )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "currentItemChanged(QListWidgetItem*,QListWidgetItem*)" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQListWidget::currentRowChanged ( int currentRow )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "currentRowChanged(int)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pcurrentRow = hb_itemPutNI( NULL, currentRow );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pcurrentRow );
        hb_itemRelease( psender );
...
void SlotsQListWidget::currentTextChanged ( const QString & currentText )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "currentTextChanged(QString)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pcurrentText = hb_itemPutC( NULL, QSTRINGTOSTRING(currentText) );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pcurrentText );
        hb_itemRelease( psender );
...
void SlotsQListWidget::itemActivated ( QListWidgetItem * item )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "itemActivated(QListWidgetItem*)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
...
void SlotsQListWidget::itemChanged ( QListWidgetItem * item )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "itemChanged(QListWidgetItem*)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pitem = hb_itemPutPtr( NULL, (QListWidgetItem *) item );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pitem );
...
void SlotsQListWidget::itemClicked ( QListWidgetItem * item )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "itemClicked(QListWidgetItem*)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pitem = hb_itemPutPtr( NULL, (QListWidgetItem *) item );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pitem );
...
void SlotsQListWidget::itemDoubleClicked ( QListWidgetItem * item )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "itemDoubleClicked(QListWidgetItem*)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pitem = hb_itemPutPtr( NULL, (QListWidgetItem *) item );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pitem );
...
void SlotsQListWidget::itemEntered ( QListWidgetItem * item )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "itemEntered(QListWidgetItem*)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pitem = hb_itemPutPtr( NULL, (QListWidgetItem *) item );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pitem );
...
void SlotsQListWidget::itemPressed ( QListWidgetItem * item )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "itemPressed(QListWidgetItem*)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pitem = hb_itemPutPtr( NULL, (QListWidgetItem *) item );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pitem );
