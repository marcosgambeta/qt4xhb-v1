...
{
  QTableWidgetItem * o = new QTableWidgetItem( ISOBJECT(1)? *(QIcon *) Qt4xHb::_qt4xhb_itemGetPtr(1) : QIcon(hb_parc(1)), PQSTRING(2), OPINT(3,QTableWidgetItem::Type) );
  Qt4xHb::_qt4xhb_returnNewObject( o, false );
}
...
{
  QTableWidgetItem * obj = (QTableWidgetItem *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
...
HB_FUNC_STATIC( QTABLEWIDGETITEM_CLONE )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnClass( ptr, "QTABLEWIDGETITEM", false );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QTABLEWIDGETITEM_TABLEWIDGET )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnQObjectClass( ptr, "QTABLEWIDGET" );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
