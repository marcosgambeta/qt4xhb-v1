...
#define GET_PTR_FROM_SELF(p) QFont *p = static_cast<QFont *>(Qt4xHb::itemGetPtrStackSelfItem())
...
#endif
      obj->setStyleHint(PQFONT_STYLEHINT(1), HB_ISNIL(2) ? static_cast<QFont::StyleStrategy>(QFont::PreferDefault)
...
{
  QFont *font = static_cast<QFont *>(hb_itemGetPtr(hb_objSendMsg(hb_param(1, HB_IT_OBJECT), "POINTER", 0)));
  QVariant *variant = new QVariant();
...
HB_FUNC_STATIC(QFONT_FROMVARIANT)
{
  if (ISNUMPAR(1) && ISQVARIANT(1)) {
    ...
    Qt4xHb::createReturnClass(font, "QFONT", true);
  } else {
    hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
  }
}
