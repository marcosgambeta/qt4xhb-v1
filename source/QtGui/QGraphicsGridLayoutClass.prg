...
HB_FUNC_STATIC( QGRAPHICSGRIDLAYOUT_SETCOLUMNFIXEDWIDTH )
{
  ...
  {
    int par1 = hb_parni(1);
    obj->setColumnFixedWidth ( par1, PQREAL(2) );
  }
  hb_itemReturn( hb_stackSelfItem() );
}
...
HB_FUNC_STATIC( QGRAPHICSGRIDLAYOUT_SETCOLUMNMAXIMUMWIDTH )
{
  ...
  {
    int par1 = hb_parni(1);
    obj->setColumnMaximumWidth ( par1, PQREAL(2) );
  }
  hb_itemReturn( hb_stackSelfItem() );
}
...
HB_FUNC_STATIC( QGRAPHICSGRIDLAYOUT_SETCOLUMNMINIMUMWIDTH )
{
  ...
  {
    int par1 = hb_parni(1);
    obj->setColumnMinimumWidth ( par1, PQREAL(2) );
  }
  hb_itemReturn( hb_stackSelfItem() );
}
...
HB_FUNC_STATIC( QGRAPHICSGRIDLAYOUT_SETCOLUMNPREFERREDWIDTH )
{
  ...
  {
    int par1 = hb_parni(1);
    obj->setColumnPreferredWidth ( par1, PQREAL(2) );
  }
  hb_itemReturn( hb_stackSelfItem() );
}
...
HB_FUNC_STATIC( QGRAPHICSGRIDLAYOUT_SETCOLUMNSPACING )
{
  ...
  {
    int par1 = hb_parni(1);
    obj->setColumnSpacing ( par1, PQREAL(2) );
  }
  hb_itemReturn( hb_stackSelfItem() );
}
...
HB_FUNC_STATIC( QGRAPHICSGRIDLAYOUT_SETROWFIXEDHEIGHT )
{
  ...
  {
    int par1 = hb_parni(1);
    obj->setRowFixedHeight ( par1, PQREAL(2) );
  }
  hb_itemReturn( hb_stackSelfItem() );
}
...
HB_FUNC_STATIC( QGRAPHICSGRIDLAYOUT_SETROWMAXIMUMHEIGHT )
{
  ...
  {
    int par1 = hb_parni(1);
    obj->setRowMaximumHeight ( par1, PQREAL(2) );
  }
  hb_itemReturn( hb_stackSelfItem() );
}
...
HB_FUNC_STATIC( QGRAPHICSGRIDLAYOUT_SETROWMINIMUMHEIGHT )
{
  ...
  {
    int par1 = hb_parni(1);
    obj->setRowMinimumHeight ( par1, PQREAL(2) );
  }
  hb_itemReturn( hb_stackSelfItem() );
}
...
HB_FUNC_STATIC( QGRAPHICSGRIDLAYOUT_SETROWPREFERREDHEIGHT )
{
  ...
  {
    int par1 = hb_parni(1);
    obj->setRowPreferredHeight ( par1, PQREAL(2) );
  }
  hb_itemReturn( hb_stackSelfItem() );
}
...
HB_FUNC_STATIC( QGRAPHICSGRIDLAYOUT_SETROWSPACING )
{
  ...
  {
    int par1 = hb_parni(1);
    obj->setRowSpacing ( par1, PQREAL(2) );
  }
  hb_itemReturn( hb_stackSelfItem() );
}
