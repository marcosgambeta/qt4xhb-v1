...
#endif
      obj->clear(HB_ISNIL(1) ? static_cast<QClipboard::Mode>(QClipboard::Clipboard) : PQCLIPBOARD_MODE(1));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
...
#endif
      const QMimeData *ptr =
          obj->mimeData(HB_ISNIL(1) ? static_cast<QClipboard::Mode>(QClipboard::Clipboard) : PQCLIPBOARD_MODE(1));
...
#endif
      obj->setImage(*PQIMAGE(1),
                    HB_ISNIL(2) ? static_cast<QClipboard::Mode>(QClipboard::Clipboard) : PQCLIPBOARD_MODE(2));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QCLIPBOARD_TEXT)
{
  if (ISBETWEEN(0, 1) && ISNUMORNIL(1)) {
    ...
    if (obj != NULL) {
      RQSTRING(obj->text(HB_ISNIL(1) ? static_cast<QClipboard::Mode>(QClipboard::Clipboard) : PQCLIPBOARD_MODE(1)));
    }
    ...
    if (obj != NULL) {
      ...
      RQSTRING(
          obj->text(par1, HB_ISNIL(2) ? static_cast<QClipboard::Mode>(QClipboard::Clipboard) : PQCLIPBOARD_MODE(2)));
