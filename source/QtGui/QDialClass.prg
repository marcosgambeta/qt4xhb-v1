...
*/
HB_FUNC( QDIAL_SETNOTCHESVISIBLE )
{
  QDial * obj = (QDial *) hb_itemGetPtr( hb_objSendMsg( hb_stackSelfItem(), "POINTER", 0 ) );
  if( obj )
  {
