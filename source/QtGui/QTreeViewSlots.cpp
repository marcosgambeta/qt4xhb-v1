...
void SlotsQTreeView::collapsed ( const QModelIndex & index )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "collapsed(QModelIndex)" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQTreeView::expanded ( const QModelIndex & index )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "expanded(QModelIndex)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pindex = hb_itemPutPtr( NULL, (QModelIndex *) &index );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pindex );
