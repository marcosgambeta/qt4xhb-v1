...
HB_FUNC_STATIC(QMOUSEEVENT_NEW)
{
  if (ISNUMPAR(5) && HB_ISNUM(1) && ISQPOINT(2) && HB_ISNUM(3) && HB_ISNUM(4) && HB_ISNUM(5)) {
    ...
    QMouseEvent *obj = new QMouseEvent(PQEVENT_TYPE(1), *PQPOINT(2), PQT_MOUSEBUTTON(3), PQT_MOUSEBUTTONS(4),
    ...
    QMouseEvent *obj = new QMouseEvent(PQEVENT_TYPE(1), *PQPOINT(2), *PQPOINT(3), PQT_MOUSEBUTTON(4),
                                       PQT_MOUSEBUTTONS(5), PQT_KEYBOARDMODIFIERS(6));
    Qt4xHb::returnNewObject(obj, false);
  } else {
...
HB_FUNC_STATIC(QMOUSEEVENT_CREATEEXTENDEDMOUSEEVENT)
{
  ...
  if (ISNUMPAR(6) && HB_ISNUM(1) && ISQPOINTF(2) && ISQPOINT(3) && HB_ISNUM(4) && HB_ISNUM(5) && HB_ISNUM(6)) {
    ...
    QMouseEvent *ptr = QMouseEvent::createExtendedMouseEvent(
        PQEVENT_TYPE(1), *PQPOINTF(2), *PQPOINT(3), PQT_MOUSEBUTTON(4), PQT_MOUSEBUTTONS(5), PQT_KEYBOARDMODIFIERS(6));
