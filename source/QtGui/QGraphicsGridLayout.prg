...
HB_FUNC_STATIC( QGRAPHICSGRIDLAYOUT_NEW )
{
  ...
  {
    QGraphicsGridLayout * o = new QGraphicsGridLayout( ISNIL(1)? 0 : (QGraphicsLayoutItem *) Qt4xHb::_qt4xhb_itemGetPtr(1) );
...
{
  QGraphicsGridLayout * obj = (QGraphicsGridLayout *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
