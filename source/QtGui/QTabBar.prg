...
void QTabBar_addTab2()
{
  ...
  if( obj )
  {
    RINT( obj->addTab( ISOBJECT(1)? *(QIcon *) Qt4xHb::_qt4xhb_itemGetPtr(1) : QIcon(hb_parc(1)), PQSTRING(2) ) );
  }
}
...
void QTabBar_insertTab2()
{
  ...
  if( obj )
  {
    RINT( obj->insertTab( PINT(1), ISOBJECT(2)? *(QIcon *) Qt4xHb::_qt4xhb_itemGetPtr(2) : QIcon(hb_parc(2)), PQSTRING(3) ) );
  }
}
...
HB_FUNC_STATIC( QTABBAR_SETTABICON )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      obj->setTabIcon( PINT(1), ISOBJECT(2)? *(QIcon *) Qt4xHb::_qt4xhb_itemGetPtr(2) : QIcon(hb_parc(2)) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QTABBAR_SETTABTEXTCOLOR )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      obj->setTabTextColor( PINT(1), ISOBJECT(2)? *(QColor *) Qt4xHb::_qt4xhb_itemGetPtr(2) : QColor(hb_parc(2)) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
