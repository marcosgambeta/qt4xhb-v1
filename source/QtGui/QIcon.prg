...
#define GET_PTR_FROM_SELF(p) QIcon *p = static_cast<QIcon *>(Qt4xHb::itemGetPtrStackSelfItem())
...
#endif
      QSize *ptr =
          new QSize(obj->actualSize(*PQSIZE(1), HB_ISNIL(2) ? static_cast<QIcon::Mode>(QIcon::Normal) : PQICON_MODE(2),
...
#endif
      obj->addPixmap(*PQPIXMAP(1), HB_ISNIL(2) ? static_cast<QIcon::Mode>(QIcon::Normal) : PQICON_MODE(2),
                     HB_ISNIL(3) ? static_cast<QIcon::State>(QIcon::Off) : PQICON_STATE(3));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
...
#endif
      QList<QSize> list = obj->availableSizes(HB_ISNIL(1) ? static_cast<QIcon::Mode>(QIcon::Normal) : PQICON_MODE(1),
...
HB_FUNC_STATIC(QICON_PAINT)
{
  if (ISBETWEEN(2, 5) && ISQPAINTER(1) && ISQRECT(2) && ISNUMORNIL(3) && ISNUMORNIL(4) && ISNUMORNIL(5)) {
    ...
    if (obj != NULL) {
      obj->paint(PQPAINTER(1), *PQRECT(2), HB_ISNIL(3) ? static_cast<Qt::Alignment>(Qt::AlignCenter) : PQT_ALIGNMENT(3),
...
#endif
      QIcon *ptr =
          new QIcon(obj->fromTheme(PQSTRING(1), HB_ISNIL(2) ? QIcon() : *static_cast<QIcon *>(Qt4xHb::itemGetPtr(2))));
      RQICON(ptr);
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
