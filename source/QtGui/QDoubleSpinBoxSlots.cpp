...
{
  QDoubleSpinBox_release_codeblocks();
}
void SlotsQDoubleSpinBox::valueChanged ( double d )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "valueChanged(double)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pd = hb_itemPutND( NULL, d );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pd );
