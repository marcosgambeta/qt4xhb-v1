...
#define GET_PTR_FROM_SELF(p) QTreeWidget *p = qobject_cast<QTreeWidget *>(Qt4xHb::getQObjectPointerFromSelfItem())
...
#endif
      QList<QTreeWidgetItem *> list = obj->findItems(PQSTRING(1), PQT_MATCHFLAGS(2), OPINT(3, 0));
