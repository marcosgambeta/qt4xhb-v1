...
void SlotsQMdiArea::subWindowActivated ( QMdiSubWindow * window )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "subWindowActivated(QMdiSubWindow*)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pwindow = hb_itemPutPtr( NULL, (QMdiSubWindow *) window );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pwindow );
