...
HB_FUNC_STATIC( QTEXTDOCUMENT_BEGIN )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnClass( ptr, "QTEXTBLOCK", true );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QTEXTDOCUMENT_DEFAULTTEXTOPTION )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnClass( ptr, "QTEXTOPTION", true );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QTEXTDOCUMENT_DOCUMENTLAYOUT )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(0) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnQObjectClass( ptr, "QABSTRACTTEXTDOCUMENTLAYOUT" );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QTEXTDOCUMENT_DRAWCONTENTS )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      obj->drawContents( PQPAINTER(1), ISNIL(2)? QRectF() : *(QRectF *) Qt4xHb::_qt4xhb_itemGetPtr(2) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QTEXTDOCUMENT_OBJECT )
{
  ...
  if( obj )
  {
    ...
    if( ISNUMPAR(1) && ISNUM(1) )
    {
      ...
      Qt4xHb::_qt4xhb_createReturnQObjectClass( ptr, "QTEXTOBJECT" );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
...
HB_FUNC_STATIC( QTEXTDOCUMENT_TOHTML )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      RQSTRING( obj->toHtml( ISNIL(1)? QByteArray() : *(QByteArray *) Qt4xHb::_qt4xhb_itemGetPtr(1) ) );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
    {
