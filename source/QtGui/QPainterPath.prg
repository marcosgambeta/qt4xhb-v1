...
{
  QPainterPath * obj = (QPainterPath *) Qt4xHb::itemGetPtrStackSelfItem();
...
void QPainterPath_toFillPolygon2()
{
  ...
  if( obj )
  {
    QPolygonF * ptr = new QPolygonF( obj->toFillPolygon( ISNIL(1)? QMatrix() : *(QMatrix *) Qt4xHb::itemGetPtr(1) ) );
    Qt4xHb::createReturnClass( ptr, "QPOLYGONF", true );
  }
}
...
void QPainterPath_toFillPolygons2()
{
  ...
  if( obj )
  {
    QList<QPolygonF> list = obj->toFillPolygons( ISNIL(1)? QMatrix() : *(QMatrix *) Qt4xHb::itemGetPtr(1) );
    PHB_DYNS pDynSym = hb_dynsymFindName( "QPOLYGONF" );
    PHB_ITEM pArray = hb_itemArrayNew(0);
    if( pDynSym )
    {
...
void QPainterPath_toSubpathPolygons2()
{
  ...
  if( obj )
  {
    QList<QPolygonF> list = obj->toSubpathPolygons( ISNIL(1)? QMatrix() : *(QMatrix *) Qt4xHb::itemGetPtr(1) );
    PHB_DYNS pDynSym = hb_dynsymFindName( "QPOLYGONF" );
    PHB_ITEM pArray = hb_itemArrayNew(0);
    if( pDynSym )
    {
