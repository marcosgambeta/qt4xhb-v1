...
HB_FUNC_STATIC(QBRUSH_NEW)
{
  if (ISNUMPAR(0)) {
    ...
    QBrush *obj = new QBrush(PQT_BRUSHSTYLE(1));
    Qt4xHb::returnNewObject(obj, true);
    ...
    QBrush *obj = new QBrush(HB_ISOBJECT(1) ? *static_cast<QColor *>(Qt4xHb::itemGetPtr(1)) : QColor(hb_parc(1)),
                             HB_ISNIL(2) ? static_cast<Qt::BrushStyle>(Qt::SolidPattern) : PQT_BRUSHSTYLE(2));
    Qt4xHb::returnNewObject(obj, true);
    ...
    QBrush *obj = new QBrush(PQT_GLOBALCOLOR(1), *PQPIXMAP(2));
    Qt4xHb::returnNewObject(obj, true);
