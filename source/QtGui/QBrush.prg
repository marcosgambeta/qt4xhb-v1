...
void QBrush_new3()
{
  QBrush * o = new QBrush( ISOBJECT(1)? *(QColor *) Qt4xHb::itemGetPtr(1) : QColor(hb_parc(1)), ISNIL(2)? (Qt::BrushStyle) Qt::SolidPattern : (Qt::BrushStyle) hb_parni(2) );
  Qt4xHb::returnNewObject( o, true );
}
...
void QBrush_new5()
{
  QBrush * o = new QBrush( ISOBJECT(1)? *(QColor *) Qt4xHb::itemGetPtr(1) : QColor(hb_parc(1)), *PQPIXMAP(2) );
  Qt4xHb::returnNewObject( o, true );
}
