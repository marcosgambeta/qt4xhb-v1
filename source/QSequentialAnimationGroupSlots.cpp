...
{
  QSequentialAnimationGroup_release_codeblocks();
}
void SlotsQSequentialAnimationGroup::currentAnimationChanged ( QAbstractAnimation * current )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "currentAnimationChanged(QAbstractAnimation*)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pcurrent = hb_itemPutPtr( NULL, (QAbstractAnimation *) current );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pcurrent );
