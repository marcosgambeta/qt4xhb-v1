...
#define GET_PTR_FROM_SELF(p) QDate *p = static_cast<QDate *>(Qt4xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QDATE_FROMSTRING)
{
  if (ISBETWEEN(1, 2) && HB_ISCHAR(1) && ISNUMORNIL(2)) {
    ...
    RQDATE(QDate::fromString(PQSTRING(1), HB_ISNIL(2) ? static_cast<Qt::DateFormat>(Qt::TextDate) : PQT_DATEFORMAT(2)));
