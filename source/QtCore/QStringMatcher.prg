...
#define GET_PTR_FROM_SELF(p) QStringMatcher *p = static_cast<QStringMatcher *>(Qt4xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QSTRINGMATCHER_NEW)
{
  if (ISNUMPAR(0)) {
    ...
    QStringMatcher *obj = new QStringMatcher(
        PQCHAR(1), PINT(2), HB_ISNIL(3) ? static_cast<Qt::CaseSensitivity>(Qt::CaseSensitive) : PQT_CASESENSITIVITY(3));
    Qt4xHb::returnNewObject(obj, true);
