...
HB_FUNC_STATIC( QABSTRACTFILEENGINEHANDLER_NEWFROMOBJECT )
{
  HB_FUNC_EXEC( QABSTRACTFILEENGINEHANDLER_NEWFROM );
}

HB_FUNC_STATIC( QABSTRACTFILEENGINEHANDLER_NEWFROMPOINTER )
{
  HB_FUNC_EXEC( QABSTRACTFILEENGINEHANDLER_NEWFROM );
}

HB_FUNC_STATIC( QABSTRACTFILEENGINEHANDLER_SELFDESTRUCTION )
{
  hb_retl( (bool) hb_itemGetL( hb_objSendMsg( hb_stackSelfItem(), "SELF_DESTRUCTION", 0 ) ) );
}

HB_FUNC_STATIC( QABSTRACTFILEENGINEHANDLER_SETSELFDESTRUCTION )
{
  PHB_ITEM self = hb_stackSelfItem();
