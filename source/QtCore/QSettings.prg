...
#define GET_PTR_FROM_SELF(p) QSettings *p = qobject_cast<QSettings *>(Qt4xHb::getQObjectPointerFromSelfItem())
...
HB_FUNC_STATIC(QSETTINGS_NEW)
{
  if (ISBETWEEN(1, 3) && HB_ISCHAR(1) && ISCHARORNIL(2) && ISQOBJECTORNIL(3)) {
    ...
    // *parent = 0)
    QSettings *obj = new QSettings(PQSETTINGS_SCOPE(1), PQSTRING(2), OPQSTRING(3, QString()), OPQOBJECT(4, 0));
    Qt4xHb::returnNewObject(obj, false);
    ...
    QSettings *obj =
        new QSettings(PQSETTINGS_FORMAT(1), PQSETTINGS_SCOPE(2), PQSTRING(3), OPQSTRING(4, QString()), OPQOBJECT(5, 0));
    Qt4xHb::returnNewObject(obj, false);
    ...
    QSettings *obj = new QSettings(PQSTRING(1), PQSETTINGS_FORMAT(2), OPQOBJECT(3, 0));
    Qt4xHb::returnNewObject(obj, false);
...
#endif
      RQVARIANT(obj->value(PQSTRING(1), HB_ISNIL(2) ? QVariant() : *static_cast<QVariant *>(Qt4xHb::itemGetPtr(2))));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
