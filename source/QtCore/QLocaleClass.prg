...
HB_FUNC_STATIC( QLOCALE_TOCURRENCYSTRING4 )
{
  ...
  {
    QString par2 = ISNIL(2)? QString() : hb_parc(2);
    QString str1 = obj->toCurrencyString ( hb_parni(1), par2 );
    hb_retc( (const char *) str1.toLatin1().data() );
  }
}
...
HB_FUNC_STATIC( QLOCALE_TOINT )
{
  ...
  if( obj )
  {
    QString par1 = hb_parc(1);
    bool par2;
    hb_retni( obj->toInt ( par1, &par2, ISNIL(3)? 0 : hb_parni(3) ) );
    hb_storl( par2, 2 );
  }
}
...
HB_FUNC_STATIC( QLOCALE_TOLONGLONG )
{
  ...
  if( obj )
  {
    QString par1 = hb_parc(1);
    bool par2;
    qlonglong l = obj->toLongLong ( par1, &par2, ISNIL(3)? 0 : hb_parni(3) );
    hb_retnl( l );
    hb_storl( par2, 2 );
  }
}
...
HB_FUNC_STATIC( QLOCALE_TOSHORT )
{
  ...
  if( obj )
  {
    QString par1 = hb_parc(1);
    bool par2;
    short i = obj->toShort ( par1, &par2, ISNIL(3)? 0 : hb_parni(3) );
    hb_retni( i );
    hb_storl( par2, 2 );
  }
}
...
HB_FUNC_STATIC( QLOCALE_TOSTRING10 )
{
  ...
  if( obj )
  {
    QString str1 = obj->toString ( hb_parni(1) );
    hb_retc( (const char *) str1.toLatin1().data() );
  }
}
...
HB_FUNC_STATIC( QLOCALE_TOSTRING12 )
{
  ...
  if( obj )
  {
    ...
    QString str1 = obj->toString ( par1, par2, ISNIL(3)? 6 : hb_parni(3) );
    hb_retc( (const char *) str1.toLatin1().data() );
  }
}
...
HB_FUNC_STATIC( QLOCALE_TOUINT )
{
  ...
  if( obj )
  {
    QString par1 = hb_parc(1);
    bool par2;
    hb_retni( (uint) obj->toUInt ( par1, &par2, ISNIL(3)? 0 : hb_parni(3) ) );
    hb_storl( par2, 2 );
  }
}
...
HB_FUNC_STATIC( QLOCALE_TOULONGLONG )
{
  ...
  if( obj )
  {
    QString par1 = hb_parc(1);
    bool par2;
    qlonglong l = obj->toULongLong ( par1, &par2, ISNIL(3)? 0 : hb_parni(3) );
    hb_retnl( l );
    hb_storl( par2, 2 );
  }
}
...
HB_FUNC_STATIC( QLOCALE_TOUSHORT )
{
  ...
  if( obj )
  {
    QString par1 = hb_parc(1);
    bool par2;
    ushort i = obj->toUShort ( par1, &par2, ISNIL(3)? 0 : hb_parni(3) );
    hb_retni( i );
    hb_storl( par2, 2 );
  }
}
