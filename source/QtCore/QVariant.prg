...
{
  QVariant *obj = new QVariant(PQT_GLOBALCOLOR(1));
...
{
  QVariant *obj = new QVariant(PQVARIANT_TYPE(1));
  Qt4xHb::returnNewObject(obj, true);
}
...
#endif
      RBOOL(obj->canConvert(PQVARIANT_TYPE(1)));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QVARIANT_CONVERT)
{
  ...
  if (obj != NULL) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      RBOOL(obj->convert(PQVARIANT_TYPE(1)));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QVARIANT_TYPETONAME)
{
  ...
  if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
    hb_retc((const char *)QVariant::typeToName(PQVARIANT_TYPE(1)));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
  } else {
    hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
  }
