...
{
  QSignalMapper_release_codeblocks();
}
void SlotsQSignalMapper::mapped(int i)
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "mapped(int)" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQSignalMapper::mapped(const QString & s)
{
  QObject *object = qobject_cast<QObject *>(sender());
  for (int i = 0; i < list1.size(); ++i)
  {
...
void SlotsQSignalMapper::mapped(QWidget * w)
{
  QObject *object = qobject_cast<QObject *>(sender());
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "mapped(QWidget*)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
...
void SlotsQSignalMapper::mapped(QObject * o)
{
  QObject *object = qobject_cast<QObject *>(sender());
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "mapped(QObject*)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM po = hb_itemPutPtr( NULL, (QObject *) o );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, po );
        hb_itemRelease( psender );
        hb_itemRelease( po );
      }
    }
