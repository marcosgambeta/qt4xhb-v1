...
HB_FUNC_STATIC(QSOCKETNOTIFIER_NEW)
{
  if (ISBETWEEN(2, 3) && HB_ISNUM(1) && HB_ISNUM(2) && ISQOBJECTORNIL(3)) {
    QSocketNotifier *obj = new QSocketNotifier(PINT(1), PQSOCKETNOTIFIER_TYPE(2), OPQOBJECT(3, 0));
...
#define CONNECT_SIGNAL(signal) QSocketNotifierSlots_connect_signal(signal, signal)
