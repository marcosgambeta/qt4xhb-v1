...
#define GET_PTR_FROM_SELF(p) QUrl *p = static_cast<QUrl *>(Qt4xHb::itemGetPtrStackSelfItem())
...
HB_FUNC_STATIC(QURL_ENCODEDFRAGMENT)
{
  ...
  if (obj != NULL) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQBYTEARRAY(obj->encodedFragment());
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QURL_ENCODEDPASSWORD)
{
  ...
  if (obj != NULL) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQBYTEARRAY(obj->encodedPassword());
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QURL_ENCODEDQUERYITEMVALUE)
{
  ...
  if (obj != NULL) {
    ...
    if (ISNUMPAR(1) && ISQBYTEARRAY(1)) {
#endif
      RQBYTEARRAY(obj->encodedQueryItemValue(*PQBYTEARRAY(1)));
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
...
HB_FUNC_STATIC(QURL_ENCODEDUSERNAME)
{
  ...
  if (obj != NULL) {
    ...
    if (ISNUMPAR(0)) {
#endif
      RQBYTEARRAY(obj->encodedUserName());
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
    }
