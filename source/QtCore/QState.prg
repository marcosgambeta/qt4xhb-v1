...
#define GET_PTR_FROM_SELF(p) QState *p = qobject_cast<QState *>(Qt4xHb::getQObjectPointerFromSelfItem())
    ...
    if (ISNUMPAR(0)) {
      ...
      if (pDynSym != NULL) {
        ...
        for (int i = 0; i < count; i++) {
          ...
          PHB_ITEM pItem = hb_itemPutPtr(NULL, static_cast<QAbstractTransition *>(list[i]));
