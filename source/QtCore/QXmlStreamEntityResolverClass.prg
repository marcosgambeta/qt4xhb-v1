...
METHOD newFrom (p) CLASS QXmlStreamEntityResolver
   IF valtype(p) == "O"
      ::pointer := p:pointer
      ::self_destruction := .f.
   ELSEIF valtype(p) == "P"
...
METHOD newFromObject (p) CLASS QXmlStreamEntityResolver
   ::pointer := p:pointer
   ::self_destruction := .f.
RETURN self

METHOD newFromPointer (p) CLASS QXmlStreamEntityResolver
   ::pointer := p
   ::self_destruction := .f.
RETURN self

METHOD selfDestruction () CLASS QXmlStreamEntityResolver
RETURN ::self_destruction

METHOD setSelfDestruction (p) CLASS QXmlStreamEntityResolver
   IF valtype(p) == "L"
      ::self_destruction := p
   ENDIF
RETURN self
