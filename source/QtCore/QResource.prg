...
HB_FUNC_STATIC( QRESOURCE_NEW )
{
  ...
  {
    QResource * o = new QResource( OPQSTRING(1,QString()), ISNIL(2)? QLocale() : *(QLocale *) Qt4xHb::_qt4xhb_itemGetPtr(2) );
...
{
  QResource * obj = (QResource *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
