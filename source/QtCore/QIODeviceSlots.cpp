...
void SlotsQIODevice::aboutToClose ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "aboutToClose()" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQIODevice::bytesWritten ( qint64 bytes )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "bytesWritten(qint64)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pbytes = hb_itemPutNI( NULL, bytes );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pbytes );
        hb_itemRelease( psender );
...
void SlotsQIODevice::readChannelFinished ()
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "readChannelFinished()" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 1, psender );
        hb_itemRelease( psender );
