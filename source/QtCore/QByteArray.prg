...
{
  QByteArray * obj = (QByteArray *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
...
HB_FUNC_STATIC( QBYTEARRAY_TOPERCENTENCODING )
{
  ...
  if( obj )
  {
    ...
    {
#endif
      QByteArray * ptr = new QByteArray( obj->toPercentEncoding( ISNIL(1)? QByteArray() : *(QByteArray *) Qt4xHb::_qt4xhb_itemGetPtr(1), ISNIL(2)? QByteArray() : *(QByteArray *) Qt4xHb::_qt4xhb_itemGetPtr(2), OPCHAR(3,'%') ) );
      Qt4xHb::_qt4xhb_createReturnClass( ptr, "QBYTEARRAY", true );
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    }
    else
