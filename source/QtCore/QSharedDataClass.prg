...
HB_FUNC_STATIC( QSHAREDDATA_NEWFROM )
{
  PHB_ITEM self = hb_stackSelfItem();
...
HB_FUNC_STATIC( QSHAREDDATA_NEWFROMOBJECT )
{
  HB_FUNC_EXEC( QSHAREDDATA_NEWFROM );
}

HB_FUNC_STATIC( QSHAREDDATA_NEWFROMPOINTER )
{
  HB_FUNC_EXEC( QSHAREDDATA_NEWFROM );
}

HB_FUNC_STATIC( QSHAREDDATA_SELFDESTRUCTION )
{
  hb_retl( (bool) hb_itemGetL( hb_objSendMsg( hb_stackSelfItem(), "SELF_DESTRUCTION", 0 ) ) );
}

HB_FUNC_STATIC( QSHAREDDATA_SETSELFDESTRUCTION )
{
  PHB_ITEM self = hb_stackSelfItem();
