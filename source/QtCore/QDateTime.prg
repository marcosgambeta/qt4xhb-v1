...
HB_FUNC_STATIC(QDATETIME_NEW)
{
  if (ISNUMPAR(0)) {
    ...
    QDateTime *obj =
        new QDateTime(*PQDATE(1), *PQTIME(2), HB_ISNIL(3) ? static_cast<Qt::TimeSpec>(Qt::LocalTime) : PQT_TIMESPEC(3));
    Qt4xHb::returnNewObject(obj, true);
...
HB_FUNC_STATIC(QDATETIME_TOTIMESPEC)
{
  ...
  if (obj != NULL) {
    ...
    if (ISNUMPAR(1) && HB_ISNUM(1)) {
#endif
      QDateTime *ptr = new QDateTime(obj->toTimeSpec(PQT_TIMESPEC(1)));
      Qt4xHb::createReturnClass(ptr, "QDATETIME", true);
#ifndef QT4XHB_DONT_CHECK_PARAMETERS
    } else {
      hb_errRT_BASE(EG_ARG, 3012, NULL, HB_ERR_FUNCNAME, HB_ERR_ARGS_BASEPARAMS);
...
HB_FUNC_STATIC(QDATETIME_FROMSTRING)
{
  if (ISBETWEEN(1, 2) && HB_ISCHAR(1) && ISNUMORNIL(2)) {
    ...
    QDateTime *ptr = new QDateTime(QDateTime::fromString(
        PQSTRING(1), HB_ISNIL(2) ? static_cast<Qt::DateFormat>(Qt::TextDate) : PQT_DATEFORMAT(2)));
    Qt4xHb::createReturnClass(ptr, "QDATETIME", true);
