...
HB_FUNC_STATIC(QVIDEOFRAME_NEW)
{
  if (ISNUMPAR(0)) {
    ...
    QVideoFrame *obj = new QVideoFrame(PQABSTRACTVIDEOBUFFER(1), *PQSIZE(2), PQVIDEOFRAME_PIXELFORMAT(3));
    Qt4xHb::returnNewObject(obj, true);
    ...
    QVideoFrame *obj = new QVideoFrame(PINT(1), *PQSIZE(2), PINT(3), PQVIDEOFRAME_PIXELFORMAT(4));
    Qt4xHb::returnNewObject(obj, true);
