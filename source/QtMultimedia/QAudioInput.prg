...
{
  QAudioInput * o = new QAudioInput( ISNIL(1)? QAudioFormat() : *(QAudioFormat *) Qt4xHb::_qt4xhb_itemGetPtr(1), OPQOBJECT(2,0) );
...
{
  QAudioInput * o = new QAudioInput( *PQAUDIODEVICEINFO(1), ISNIL(2)? QAudioFormat() : *(QAudioFormat *) Qt4xHb::_qt4xhb_itemGetPtr(2), OPQOBJECT(3,0) );
  Qt4xHb::_qt4xhb_returnNewObject( o, false );
}
...
{
  QAudioInput * obj = (QAudioInput *) Qt4xHb::_qt4xhb_itemGetPtrStackSelfItem();
