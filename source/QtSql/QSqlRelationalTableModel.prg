...
HB_FUNC_STATIC( QSQLRELATIONALTABLEMODEL_NEW )
{
  ...
  {
    QSqlRelationalTableModel * obj = new QSqlRelationalTableModel( OPQOBJECT( 1, 0 ), ISNIL( 2 ) ? QSqlDatabase() : *static_cast< QSqlDatabase * >( Qt4xHb::itemGetPtr( 2 ) ) );
...
{
  QSqlRelationalTableModel * obj = static_cast< QSqlRelationalTableModel * >( Qt4xHb::itemGetPtrStackSelfItem() );
