...
{
  QFontDialog_release_codeblocks();
}
void SlotsQFontDialog::currentFontChanged ( const QFont & font )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "currentFontChanged(QFont)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pfont = hb_itemPutPtr( NULL, (QFont *) &font );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pfont );
...
void SlotsQFontDialog::fontSelected ( const QFont & font )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "fontSelected(QFont)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM pfont = hb_itemPutPtr( NULL, (QFont *) &font );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, pfont );
