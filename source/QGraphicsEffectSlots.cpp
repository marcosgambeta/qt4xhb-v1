...
{
  QGraphicsEffect_release_codeblocks();
}
void SlotsQGraphicsEffect::enabledChanged ( bool enabled )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "enabledChanged(bool)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
        PHB_ITEM penabled = hb_itemPutL( NULL, enabled );
        hb_vmEvalBlockV( (PHB_ITEM) list3.at(i), 2, psender, penabled );
