...
void QWebPageSlots::contentsChanged()
{
  ...
  if( cb )
  {
    PHB_ITEM psender = Signals_return_qobject ( object, "QWEBPAGE" );
...
void QWebPageSlots::databaseQuotaExceeded( QWebFrame * frame, QString databaseName )
{
  ...
  {
    PHB_ITEM psender = Signals_return_qobject ( object, "QWEBPAGE" );
    PHB_ITEM pframe = Signals_return_qobject( frame, "QWEBFRAME" );
...
void QWebPageSlots::unsupportedContent( QNetworkReply * reply )
{
  ...
  {
    PHB_ITEM psender = Signals_return_qobject ( object, "QWEBPAGE" );
    PHB_ITEM preply = Signals_return_qobject( reply, "QNETWORKREPLY" );
