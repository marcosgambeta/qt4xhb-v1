...
{
  QDeclarativeComponent_release_codeblocks();
}
void SlotsQDeclarativeComponent::progressChanged ( qreal progress )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    ...
    {
      if( ( (QString) list2.at(i) == (QString) "progressChanged(qreal)" ) && ( (bool) list4.at(i) == true ) )
      {
...
void SlotsQDeclarativeComponent::statusChanged ( QDeclarativeComponent::Status status )
{
  ...
  for (int i = 0; i < list1.size(); ++i)
  {
    if( (QObject*) list1.at(i) == (QObject*) object )
    {
      if( ( (QString) list2.at(i) == (QString) "statusChanged(QDeclarativeComponent::Status)" ) && ( (bool) list4.at(i) == true ) )
      {
        PHB_ITEM psender = hb_itemPutPtr( NULL, (QObject *) object );
